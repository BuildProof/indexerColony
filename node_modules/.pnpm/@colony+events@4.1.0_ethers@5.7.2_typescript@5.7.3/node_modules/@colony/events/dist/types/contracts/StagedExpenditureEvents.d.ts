...
export interface StagedExpenditureEventsInterface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "ExpenditureMadeStaged(uint256,bool)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ExpenditureMadeStaged(address,uint256,bool)"): EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "StagedPaymentReleased(uint256,uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "StagedPaymentReleased(address,uint256,uint256)"): EventFragment;
...
export interface ExpenditureMadeStaged_uint256_bool_EventObject {
    expenditureId: BigNumber;
    staged: boolean;
}
export type ExpenditureMadeStaged_uint256_bool_Event = TypedEvent<[
    BigNumber,
    boolean
], ExpenditureMadeStaged_uint256_bool_EventObject>;
export type ExpenditureMadeStaged_uint256_bool_EventFilter = TypedEventFilter<ExpenditureMadeStaged_uint256_bool_Event>;
export interface ExpenditureMadeStaged_address_uint256_bool_EventObject {
    agent: string;
    expenditureId: BigNumber;
    staged: boolean;
}
export type ExpenditureMadeStaged_address_uint256_bool_Event = TypedEvent<[
    string,
    BigNumber,
    boolean
], ExpenditureMadeStaged_address_uint256_bool_EventObject>;
export type ExpenditureMadeStaged_address_uint256_bool_EventFilter = TypedEventFilter<ExpenditureMadeStaged_address_uint256_bool_Event>;
...
export interface StagedPaymentReleased_uint256_uint256_EventObject {
    expenditureId: BigNumber;
    slot: BigNumber;
}
export type StagedPaymentReleased_uint256_uint256_Event = TypedEvent<[
    BigNumber,
    BigNumber
], StagedPaymentReleased_uint256_uint256_EventObject>;
export type StagedPaymentReleased_uint256_uint256_EventFilter = TypedEventFilter<StagedPaymentReleased_uint256_uint256_Event>;
export interface StagedPaymentReleased_address_uint256_uint256_EventObject {
    agent: string;
    expenditureId: BigNumber;
    slot: BigNumber;
}
export type StagedPaymentReleased_address_uint256_uint256_Event = TypedEvent<[
    string,
    BigNumber,
    BigNumber
], StagedPaymentReleased_address_uint256_uint256_EventObject>;
export type StagedPaymentReleased_address_uint256_uint256_EventFilter = TypedEventFilter<StagedPaymentReleased_address_uint256_uint256_Event>;
...
export interface StagedExpenditureEvents extends BaseContract {
    ...
    filters: {
        ...
        "ExpenditureMadeStaged(uint256,bool)"(expenditureId?: BigNumberish | null, staged?: null): ExpenditureMadeStaged_uint256_bool_EventFilter;
        "ExpenditureMadeStaged(address,uint256,bool)"(agent?: null, expenditureId?: BigNumberish | null, staged?: null): ExpenditureMadeStaged_address_uint256_bool_EventFilter;
        ...
        "StagedPaymentReleased(uint256,uint256)"(expenditureId?: BigNumberish | null, slot?: null): StagedPaymentReleased_uint256_uint256_EventFilter;
        "StagedPaymentReleased(address,uint256,uint256)"(agent?: null, expenditureId?: BigNumberish | null, slot?: null): StagedPaymentReleased_address_uint256_uint256_EventFilter;
