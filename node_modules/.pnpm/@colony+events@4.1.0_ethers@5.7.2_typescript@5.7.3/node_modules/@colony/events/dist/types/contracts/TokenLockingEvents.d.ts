...
export interface TokenLockingEventsInterface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "TokenLocked(address,uint256)"): EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "UserTokenDeposited(address,address,uint256,uint256)"): EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "ReputationMinerPenalised(address,address,uint256)"): EventFragment;
...
export type TokenLocked_address_uint256_EventFilter = TypedEventFilter<TokenLocked_address_uint256_Event>;
...
export type TokenLocked_address_address_uint256_EventFilter = TypedEventFilter<TokenLocked_address_address_uint256_Event>;
...
export type UserTokenDeposited_address_address_uint256_uint256_Event = TypedEvent<[
    string,
    string,
    BigNumber,
    BigNumber
], UserTokenDeposited_address_address_uint256_uint256_EventObject>;
export type UserTokenDeposited_address_address_uint256_uint256_EventFilter = TypedEventFilter<UserTokenDeposited_address_address_uint256_uint256_Event>;
...
export type UserTokenDeposited_address_address_uint256_EventFilter = TypedEventFilter<UserTokenDeposited_address_address_uint256_Event>;
...
export interface TokenLockingEvents extends BaseContract {
    ...
    filters: {
        ...
        "TokenLocked(address,uint256)"(token?: null, lockCount?: null): TokenLocked_address_uint256_EventFilter;
        "TokenLocked(address,address,uint256)"(token?: string | null, lockedBy?: string | null, lockCount?: null): TokenLocked_address_address_uint256_EventFilter;
        ...
        "UserTokenDeposited(address,address,uint256,uint256)"(token?: null, user?: null, amount?: null, timestamp?: null): UserTokenDeposited_address_address_uint256_uint256_EventFilter;
        "UserTokenDeposited(address,address,uint256)"(token?: null, user?: null, amount?: null): UserTokenDeposited_address_address_uint256_EventFilter;
