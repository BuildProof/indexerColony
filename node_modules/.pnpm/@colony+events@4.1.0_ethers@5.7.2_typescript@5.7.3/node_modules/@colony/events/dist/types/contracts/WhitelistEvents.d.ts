...
export interface WhitelistEventsInterface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "AgreementSigned(address)"): EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "UserApproved(address,bool)"): EventFragment;
...
export interface WhitelistEvents extends BaseContract {
    ...
    callStatic: {};
    filters: {
        "AgreementSigned(address)"(_user?: string | null): AgreementSignedEventFilter;
        ...
        "UserApproved(address,bool)"(_user?: string | null, _status?: null): UserApprovedEventFilter;
        UserApproved(_user?: string | null, _status?: null): UserApprovedEventFilter;
