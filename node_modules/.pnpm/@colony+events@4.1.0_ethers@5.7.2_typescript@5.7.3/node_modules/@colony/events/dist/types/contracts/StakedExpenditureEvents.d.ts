...
export interface StakedExpenditureEventsInterface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "ExpenditureMadeViaStake(address,uint256,uint256)"): EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "StakeFractionSet(address,uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "StakeReclaimed"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "StakeReclaimed(uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ExpenditureStakerPunished"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ExpenditureStakerPunished(address,uint256,bool)"): EventFragment;
}
...
export type ExpenditureMadeViaStakeEventFilter = TypedEventFilter<ExpenditureMadeViaStakeEvent>;
...
export type StakeFractionSet_uint256_EventFilter = TypedEventFilter<StakeFractionSet_uint256_Event>;
...
export type StakeFractionSet_address_uint256_EventFilter = TypedEventFilter<StakeFractionSet_address_uint256_Event>;
...
export type ExpenditureStakerPunishedEventFilter = TypedEventFilter<ExpenditureStakerPunishedEvent>;
export interface StakedExpenditureEvents extends BaseContract {
    ...
    callStatic: {};
    filters: {
        "ExpenditureCancelled(uint256)"(expenditureId?: null): ExpenditureCancelled_uint256_EventFilter;
        "ExpenditureCancelled(address,uint256)"(agent?: null, expenditureId?: null): ExpenditureCancelled_address_uint256_EventFilter;
        "ExpenditureMadeViaStake(address,uint256,uint256)"(creator?: string | null, expenditureId?: null, stake?: null): ExpenditureMadeViaStakeEventFilter;
        ExpenditureMadeViaStake(creator?: string | null, expenditureId?: null, stake?: null): ExpenditureMadeViaStakeEventFilter;
        ...
        "StakeFractionSet(uint256)"(stakeFraction?: null): StakeFractionSet_uint256_EventFilter;
        "StakeFractionSet(address,uint256)"(agent?: null, stakeFraction?: null): StakeFractionSet_address_uint256_EventFilter;
