...
export interface FundingQueueEventsInterface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "ProposalBacked(uint256,uint256,address,uint256,uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalCancelled"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalCancelled(uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalCompleted"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalCompleted(uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalCreated"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalCreated(uint256,uint256,uint256,address,uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalPinged"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalPinged(uint256,uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalStakeReclaimed"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalStakeReclaimed(uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalStaked"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ProposalStaked(uint256,uint256)"): EventFragment;
...
export type ProposalCancelledEventFilter = TypedEventFilter<ProposalCancelledEvent>;
...
export type ProposalCompletedEventFilter = TypedEventFilter<ProposalCompletedEvent>;
...
export type ProposalStakeReclaimedEventFilter = TypedEventFilter<ProposalStakeReclaimedEvent>;
...
export interface FundingQueueEvents extends BaseContract {
    ...
    filters: {
        ...
        "ProposalBacked(uint256,uint256,address,uint256,uint256)"(id?: BigNumberish | null, newPrevId?: BigNumberish | null, user?: string | null, backing?: null, prevBacking?: null): ProposalBackedEventFilter;
        ProposalBacked(id?: BigNumberish | null, newPrevId?: BigNumberish | null, user?: string | null, backing?: null, prevBacking?: null): ProposalBackedEventFilter;
        "ProposalCancelled(uint256)"(id?: BigNumberish | null): ProposalCancelledEventFilter;
        ProposalCancelled(id?: BigNumberish | null): ProposalCancelledEventFilter;
        "ProposalCompleted(uint256)"(id?: BigNumberish | null): ProposalCompletedEventFilter;
        ProposalCompleted(id?: BigNumberish | null): ProposalCompletedEventFilter;
        "ProposalCreated(uint256,uint256,uint256,address,uint256)"(id?: null, fromPot?: BigNumberish | null, toPot?: BigNumberish | null, token?: string | null, amount?: null): ProposalCreatedEventFilter;
        ProposalCreated(id?: null, fromPot?: BigNumberish | null, toPot?: BigNumberish | null, token?: string | null, amount?: null): ProposalCreatedEventFilter;
        "ProposalPinged(uint256,uint256)"(id?: BigNumberish | null, amount?: null): ProposalPingedEventFilter;
        ProposalPinged(id?: BigNumberish | null, amount?: null): ProposalPingedEventFilter;
        "ProposalStakeReclaimed(uint256)"(id?: BigNumberish | null): ProposalStakeReclaimedEventFilter;
        ProposalStakeReclaimed(id?: BigNumberish | null): ProposalStakeReclaimedEventFilter;
        "ProposalStaked(uint256,uint256)"(id?: BigNumberish | null, domainTotalRep?: null): ProposalStakedEventFilter;
