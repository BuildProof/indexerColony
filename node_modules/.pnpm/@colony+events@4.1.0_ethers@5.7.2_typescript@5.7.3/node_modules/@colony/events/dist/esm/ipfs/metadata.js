 ...
 */
export const parseEventMetadata = (input, type) => {
    const res = (input => {
        const __is = input => {
 ...
 */
export const getEventMetadataVersion = (input) => {
 ...
 * @returns The version number of the metadata
 */
export const createMetadataFor = (type, data) => {
    const result = type === MetadataType.Colony
