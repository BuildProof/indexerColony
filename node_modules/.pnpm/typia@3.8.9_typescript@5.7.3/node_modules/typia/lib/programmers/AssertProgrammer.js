...
(function (AssertProgrammer) {
    AssertProgrammer.generate = function (project, modulo, equals) {
        ...
        return function (type, name) {
            return AssertProgrammer.write(project)(modulo)(equals)(type, name);
        };
    };
        ...
        return function (modulo) {
            return function (equals) {
                return function (type, name) {
                    ...
                    var program = CheckerProgrammer_1.CheckerProgrammer.write(project)({
                        functors: "$ao",
                        unioners: "$au",
                        path: true,
                        trace: true,
                        ...
                        equals: equals,
                        atomist: function (explore) { return function (tuple) { return function (input) {
                            return __spreadArray([
                                tuple.expression
                            ], __read(tuple.tags.map(function (tag) {
                                return typescript_1.default.factory.createLogicalOr(tag.expression, create_guard_call(importer)(explore.from === "top"
                    ...
                    return typescript_1.default.factory.createArrowFunction(undefined, undefined, [
                        ...
                        StatementFactory_1.StatementFactory.constant("__is", IsProgrammer_1.IsProgrammer.write(project)(modulo, true)(equals)(type, name !== null && name !== void 0 ? name : TypeFactory_1.TypeFactory.getFullName(project.checker)(type))),
