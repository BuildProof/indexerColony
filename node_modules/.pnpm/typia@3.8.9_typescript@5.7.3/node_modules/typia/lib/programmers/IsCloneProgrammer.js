...
exports.IsCloneProgrammer = void 0;
...
var IsCloneProgrammer;
(function (IsCloneProgrammer) {
    IsCloneProgrammer.generate = function (project, modulo) {
        return function (type, name) {
            return IsCloneProgrammer.write(project)(modulo)(type, name);
        };
    };
    IsCloneProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                return typescript_1.default.factory.createArrowFunction(undefined, undefined, [
                    ...
                    typescript_1.default.factory.createTypeReferenceNode("typia.Primitive<".concat(name !== null && name !== void 0 ? name : TypeFactory_1.TypeFactory.getFullName(project.checker)(type), ">")),
...
})(IsCloneProgrammer = exports.IsCloneProgrammer || (exports.IsCloneProgrammer = {}));
