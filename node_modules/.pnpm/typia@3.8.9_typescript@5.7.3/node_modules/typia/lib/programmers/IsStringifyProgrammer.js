...
exports.IsStringifyProgrammer = void 0;
var typescript_1 = __importDefault(require("typescript"));
var IdentifierFactory_1 = require("../factories/IdentifierFactory");
var StatementFactory_1 = require("../factories/StatementFactory");
var TypeFactory_1 = require("../factories/TypeFactory");
var IsProgrammer_1 = require("./IsProgrammer");
var StringifyProgrammer_1 = require("./StringifyProgrammer");
var IsStringifyProgrammer;
(function (IsStringifyProgrammer) {
    IsStringifyProgrammer.generate = function (project, modulo) {
        return function (type, name) {
            return IsStringifyProgrammer.write(project)(modulo)(type, name);
        };
    };
    IsStringifyProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                return typescript_1.default.factory.createArrowFunction(undefined, undefined, [
                    ...
                    StatementFactory_1.StatementFactory.constant("is", IsProgrammer_1.IsProgrammer.write(__assign(__assign({}, project), { options: __assign(__assign({}, project.options), { functional: false, numeric: true }) }))(modulo)(false)(type, name)),
                    StatementFactory_1.StatementFactory.constant("stringify", StringifyProgrammer_1.StringifyProgrammer.write(__assign(__assign({}, project), { options: __assign(__assign({}, project.options), { functional: false, numeric: false }) }))(modulo)(type, name)),
...
})(IsStringifyProgrammer = exports.IsStringifyProgrammer || (exports.IsStringifyProgrammer = {}));
