...
(function (PruneProgrammer) {
    PruneProgrammer.generate = function (project, modulo) {
        return function (type, name) {
            return PruneProgrammer.write(project)(modulo)(type, name);
        };
    };
    PruneProgrammer.write = function (project) { return function (modulo) {
    ...
    var decode_array = function (project) { return function (importer) {
        return FeatureProgrammer_1.FeatureProgrammer.decode_array(configure(project)(importer))(importer)(PruneJoiner_1.PruneJoiner.array);
    }; };
