...
exports.ValidateCloneProgrammer = void 0;
var typescript_1 = __importDefault(require("typescript"));
var IdentifierFactory_1 = require("../factories/IdentifierFactory");
var StatementFactory_1 = require("../factories/StatementFactory");
var TypeFactory_1 = require("../factories/TypeFactory");
var CloneProgrammer_1 = require("./CloneProgrammer");
var ValidateProgrammer_1 = require("./ValidateProgrammer");
var ValidateCloneProgrammer;
(function (ValidateCloneProgrammer) {
    ValidateCloneProgrammer.generate = function (project, modulo) {
        return function (type, name) {
            return ValidateCloneProgrammer.write(project)(modulo)(type, name);
        };
    };
    ValidateCloneProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                return typescript_1.default.factory.createArrowFunction(undefined, undefined, [
                ...
                ], typescript_1.default.factory.createTypeReferenceNode("typia.IValidation<typia.Primitive<".concat(name !== null && name !== void 0 ? name : TypeFactory_1.TypeFactory.getFullName(project.checker)(type), ">>")), undefined, typescript_1.default.factory.createBlock([
                    ...
                    StatementFactory_1.StatementFactory.constant("clone", CloneProgrammer_1.CloneProgrammer.write(__assign(__assign({}, project), { options: __assign(__assign({}, project.options), { functional: false, numeric: false }) }))(modulo)(type, name)),
...
})(ValidateCloneProgrammer = exports.ValidateCloneProgrammer || (exports.ValidateCloneProgrammer = {}));
