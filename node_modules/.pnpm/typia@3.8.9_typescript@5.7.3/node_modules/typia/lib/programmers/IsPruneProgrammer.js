...
(function (IsPruneProgrammer) {
    IsPruneProgrammer.generate = function (project, modulo) {
        return function (type, name) {
            return IsPruneProgrammer.write(project)(modulo)(type, name);
        };
    };
    IsPruneProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                ...
                ], typescript_1.default.factory.createTypePredicateNode(undefined, "input", typescript_1.default.factory.createTypeReferenceNode(name !== null && name !== void 0 ? name : TypeFactory_1.TypeFactory.getFullName(project.checker)(type))), undefined, typescript_1.default.factory.createBlock([
                    StatementFactory_1.StatementFactory.constant("is", IsProgrammer_1.IsProgrammer.write(project)(modulo)(false)(type, name)),
                    StatementFactory_1.StatementFactory.constant("prune", PruneProgrammer_1.PruneProgrammer.write(__assign(__assign({}, project), { options: __assign(__assign({}, project.options), { functional: false, numeric: false }) }))(modulo)(type, name)),
