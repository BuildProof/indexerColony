...
(function (RandomProgrammer) {
    RandomProgrammer.generate = function (project, modulo, init) {
        return function (type, name) {
            return RandomProgrammer.write(project)(modulo)(init)(type, name);
        };
    };
