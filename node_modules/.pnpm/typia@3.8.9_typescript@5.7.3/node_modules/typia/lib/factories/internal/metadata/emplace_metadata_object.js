                        ...
                        return function (identifier) {
                            return function (symbol, filter) {
                                ...
                                var description = symbol
                                    ? CommentFactory_1.CommentFactory.description(symbol)
                                    : undefined;
                                var jsDocTags = ((_a = symbol === null || symbol === void 0 ? void 0 : symbol.getJsDocTags()) !== null && _a !== void 0 ? _a : []).filter(filter !== null && filter !== void 0 ? filter : (function () { return true; }));
                                var property = MetadataProperty_1.MetadataProperty.create({
                                    key: key,
                                    value: value,
                                    description: description,
                                    jsDocTags: jsDocTags,
                                    tags: MetadataTagFactory_1.MetadataTagFactory.generate(value)(jsDocTags)(function () {
                                        return identifier();
                                    }),
                                });
