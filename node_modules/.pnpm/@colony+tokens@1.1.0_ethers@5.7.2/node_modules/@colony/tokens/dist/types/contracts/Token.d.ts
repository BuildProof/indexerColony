...
export interface TokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "authority" | "authority()" | "balanceOf" | "balanceOf(address)" | "decimals" | "decimals()" | "locked" | "locked()" | "name" | "name()" | "owner" | "owner()" | "setAuthority" | "setAuthority(address)" | "setOwner" | "setOwner(address)" | "symbol" | "symbol()" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)" | "mint(address,uint256)" | "mint(uint256)" | "burn(uint256)" | "burn(address,uint256)" | "unlock" | "unlock()"): FunctionFragment;
