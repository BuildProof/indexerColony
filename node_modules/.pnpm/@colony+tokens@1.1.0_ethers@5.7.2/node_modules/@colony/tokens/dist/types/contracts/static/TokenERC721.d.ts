...
export interface TokenERC721Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "getApproved" | "getApproved(uint256)" | "isApprovedForAll" | "isApprovedForAll(address,address)" | "name" | "name()" | "ownerOf" | "ownerOf(uint256)" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setApprovalForAll(address,bool)" | "supportsInterface" | "supportsInterface(bytes4)" | "symbol" | "symbol()" | "tokenURI" | "tokenURI(uint256)" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;
