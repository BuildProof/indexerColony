...
export interface TokenERC2612Interface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "decimals" | "decimals()" | "name" | "name()" | "symbol" | "symbol()" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)" | "permit" | "permit(address,address,uint256,uint256,uint8,bytes32,bytes32)" | "DOMAIN_SEPARATOR" | "DOMAIN_SEPARATOR()" | "nonces" | "nonces(address)"): FunctionFragment;
...
export interface TokenERC2612 extends BaseContract {
