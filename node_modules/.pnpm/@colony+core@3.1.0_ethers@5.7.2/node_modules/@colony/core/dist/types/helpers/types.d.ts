...
export interface CommonNetwork extends BaseContract {
    getChildSkillId(skillId: BigNumberish, childSkillIndex: BigNumberish): Promise<BigNumber>;
...
export interface CommonColony extends BaseContract {
    ...
    hasUserRole(user: string, domainId: BigNumberish, role: BigNumberish): Promise<boolean>;
}
