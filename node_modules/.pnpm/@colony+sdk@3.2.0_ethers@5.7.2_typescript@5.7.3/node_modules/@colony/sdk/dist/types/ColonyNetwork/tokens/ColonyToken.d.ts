import { type ColonyToken as ColonyTokenType } from '@colony/tokens';
import type { ColonyNetwork } from '../ColonyNetwork.js';
import { ERC20Token } from './ERC20Token.js';
export declare class ColonyToken extends ERC20Token {
     ...
     */
    setAuthority(address: string): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<ColonyTokenType, "setAuthority", {
     ...
     */
    setOwner(address: string): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<ColonyTokenType, "setOwner", {
