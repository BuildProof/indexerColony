...
export declare namespace ColonyDataTypes {
    ...
    type DomainStructOutput = [BigNumber, BigNumber, boolean] & {
        skillId: BigNumber;
    ...
    type LocalSkillStruct = {
        exists: boolean;
        deprecated: boolean;
    };
    type LocalSkillStructOutput = [boolean, boolean] & {
        exists: boolean;
        deprecated: boolean;
    };
    type PaymentStruct = {
...
export interface IColonyInterface extends utils.Interface {
    functions: {
        ...
        "getLocalSkill(uint256)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getLocalSkill", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "getLocalSkill(uint256)", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "getLocalSkill", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getLocalSkill(uint256)", data: BytesLike): Result;
...
export interface IColony extends BaseContract {
    ...
    functions: {
        ...
        getLocalSkill(localSkillId: BigNumberish, overrides?: CallOverrides): Promise<[
            ColonyDataTypes.LocalSkillStructOutput
        ] & {
            localSkill: ColonyDataTypes.LocalSkillStructOutput;
        }>;
        "getLocalSkill(uint256)"(localSkillId: BigNumberish, overrides?: CallOverrides): Promise<[
            ColonyDataTypes.LocalSkillStructOutput
        ] & {
            localSkill: ColonyDataTypes.LocalSkillStructOutput;
        }>;
    ...
    getFundingPotPayout(_potId: BigNumberish, _token: string, overrides?: CallOverrides): Promise<BigNumber>;
    "getFundingPotPayout(uint256,address)"(_potId: BigNumberish, _token: string, overrides?: CallOverrides): Promise<BigNumber>;
    getLocalSkill(localSkillId: BigNumberish, overrides?: CallOverrides): Promise<ColonyDataTypes.LocalSkillStructOutput>;
    "getLocalSkill(uint256)"(localSkillId: BigNumberish, overrides?: CallOverrides): Promise<ColonyDataTypes.LocalSkillStructOutput>;
    getMetatransactionNonce(userAddress: string, overrides?: CallOverrides): Promise<BigNumber>;
    "getMetatransactionNonce(address)"(userAddress: string, overrides?: CallOverrides): Promise<BigNumber>;
    getNonRewardPotsTotal(_token: string, overrides?: CallOverrides): Promise<BigNumber>;
    "getNonRewardPotsTotal(address)"(_token: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    estimateGas: {
        ...
        getFundingPotPayout(_potId: BigNumberish, _token: string, overrides?: CallOverrides): Promise<BigNumber>;
        "getFundingPotPayout(uint256,address)"(_potId: BigNumberish, _token: string, overrides?: CallOverrides): Promise<BigNumber>;
        getLocalSkill(localSkillId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "getLocalSkill(uint256)"(localSkillId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getMetatransactionNonce(userAddress: string, overrides?: CallOverrides): Promise<BigNumber>;
        "getMetatransactionNonce(address)"(userAddress: string, overrides?: CallOverrides): Promise<BigNumber>;
        getNonRewardPotsTotal(_token: string, overrides?: CallOverrides): Promise<BigNumber>;
        "getNonRewardPotsTotal(address)"(_token: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getLocalSkill(localSkillId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "getLocalSkill(uint256)"(localSkillId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
