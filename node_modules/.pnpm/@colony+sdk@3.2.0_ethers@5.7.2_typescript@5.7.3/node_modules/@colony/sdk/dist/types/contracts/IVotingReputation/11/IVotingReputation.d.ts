...
export declare namespace VotingReputationDataTypes {
    type ActionSummaryStruct = {
        sig: BytesLike;
        domainSkillId: BigNumberish;
        expenditureId: BigNumberish;
    };
    type ActionSummaryStructOutput = [string, BigNumber, BigNumber] & {
        sig: string;
...
export interface IVotingReputation extends BaseContract {
    ...
    getActionSummary(_action: BytesLike, _altTarget: string, overrides?: CallOverrides): Promise<VotingReputationDataTypes.ActionSummaryStructOutput>;
    "getActionSummary(bytes,address)"(_action: BytesLike, _altTarget: string, overrides?: CallOverrides): Promise<VotingReputationDataTypes.ActionSummaryStructOutput>;
    getCapabilityRoles(_sig: BytesLike, overrides?: CallOverrides): Promise<string>;
    "getCapabilityRoles(bytes4)"(_sig: BytesLike, overrides?: CallOverrides): Promise<string>;
    getColony(overrides?: CallOverrides): Promise<string>;
    "getColony()"(overrides?: CallOverrides): Promise<string>;
