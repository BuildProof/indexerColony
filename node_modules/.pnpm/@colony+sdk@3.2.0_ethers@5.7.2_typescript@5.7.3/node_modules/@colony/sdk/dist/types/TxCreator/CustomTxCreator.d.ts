import { type ExtractAbiFunction, type AbiParametersToPrimitiveTypes, type Abi, type ExtractAbiFunctionNames } from 'abitype';
import { type ContractReceipt } from 'ethers';
import { type EventData, type TxConfig } from './TxCreator.js';
import { type MetaTxBaseContract, MetaTxCreator } from '.pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk';
 ...
 */
declare class CustomTxCreator<A extends Abi, M extends ExtractAbiFunctionNames<A, 'payable' | 'nonpayable'>, E extends EventData> extends MetaTxCreator<MetaTxBaseContract, M, E> {
    constructor({ contract, config, method, args, eventData, txConfig, }: {
        contract: MetaTxBaseContract;
        config: ContractConfig;
        method: M;
        args: AbiParametersToPrimitiveTypes<ExtractAbiFunction<A, M>['inputs'], 'inputs'>;
