...
import { type VotingReputationVersion, Extension } from '@colony/core';
import { type DecisionData, MetadataType } from '@colony/events';
...
import { type IVotingReputation as VotingReputationContract11, IVotingReputation__factory as VotingReputationFactory11 } from '../contracts/IVotingReputation/11/index.js';
import { type IVotingReputation as VotingReputationContract12, IVotingReputation__factory as VotingReputationFactory12 } from '../contracts/IVotingReputation/12/index.js';
import { type IVotingReputation as VotingReputationContract13, IVotingReputation__factory as VotingReputationFactory13 } from '../contracts/IVotingReputation/13/index.js';
import { type Colony } from './Colony.js';
export type SupportedVotingReputationContract = VotingReputationContract11 | VotingReputationContract12 | VotingReputationContract13;
export type Motion = VotingReputationDataTypes11.MotionStructOutput | VotingReputationDataTypes12.MotionStructOutput | VotingReputationDataTypes13.MotionStructOutput;
 ...
 *
 */
export declare class VotingReputation {
    static supportedVersions: ({
        version: number;
        factory: typeof VotingReputationFactory11;
    } | {
        version: number;
        factory: typeof VotingReputationFactory12;
    } | {
        version: number;
        factory: typeof VotingReputationFactory13;
    })[];
    static extensionType: Extension.VotingReputation;
    static connect(colony: Colony): Promise<VotingReputation>;
    private colony;
    private votingReputationContract;
    address: string;
    version: VotingReputationVersion;
    static getLatestSupportedVersion(): VotingReputationVersion;
    constructor(colony: Colony, votingReputationContract: SupportedVotingReputationContract, deployedVersion: VotingReputationVersion);
    /**
     * Have the user sign a message to create a salt for casting and revealing a vote
     */
    private createMotionSalt;
    /**
     ...
     */
    initialize(totalStakeFraction: BigNumber, voterRewardFraction: BigNumber, userMinStakeFraction: BigNumber, maxVoteFraction: BigNumber, stakePeriod: number, submitPeriod: number, revealPeriod: number, escalationPeriod: number): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<SupportedVotingReputationContract, "initialise", {}, MetadataType>;
    /**
     ...
     */
    getMotion(motionId: BigNumberish): Promise<Motion>;
    /**
     ...
     */
    getMotionResult(motionId: BigNumberish): Promise<Vote | null>;
    /**
     ...
     */
    getMotionState(motionId: BigNumberish): Promise<number>;
    /**
     ...
     */
    getMinStake(motion: Motion, vote: Vote): Promise<BigNumber>;
    /**
     ...
     */
    getRemainingStakes(motionId: BigNumberish): Promise<{
        remainingToFullyNayStaked: BigNumber;
        remainingToFullyYayStaked: BigNumber;
    }>;
    /**
     ...
     */
    createDecision(team?: BigNumberish): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<SupportedVotingReputationContract, "createMotion", {
        motionId?: BigNumber | undefined;
     ...
     */
    annotateDecision(txHash: string, metadata: DecisionData | string): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<import("./Colony.js").SupportedColonyContract, "annotateTransaction", {
     ...
     */
    approveStake(amount: BigNumberish, teamId?: BigNumberish): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<import("./Colony.js").SupportedColonyContract, "approveStake", {
     ...
     */
    stakeMotion(motionId: BigNumberish, vote: Vote, amount: BigNumberish): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<SupportedVotingReputationContract, "stakeMotion", {
        motionId?: BigNumber | undefined;
        eventIndex?: BigNumber | undefined;
        staker?: string | undefined;
        vote?: BigNumber | undefined;
        amount?: BigNumber | undefined;
    }, MetadataType>;
    /**
     ...
     */
    submitVote(motionId: BigNumberish, vote: Vote): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<SupportedVotingReputationContract, "submitVote", {
        motionId?: BigNumber | undefined;
     ...
     */
    revealVote(motionId: BigNumberish, vote?: Vote): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<SupportedVotingReputationContract, "revealVote", {
        motionId?: BigNumber | undefined;
        voter?: string | undefined;
        vote?: BigNumber | undefined;
    }, MetadataType>;
     ...
     */
    escalateMotion(motionId: BigNumberish, newTeamId: BigNumberish): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<SupportedVotingReputationContract, "escalateMotion", {
        motionId?: BigNumber | undefined;
        escalator?: string | undefined;
        domainId?: BigNumber | undefined;
        newDomainId?: BigNumber | undefined;
    }, MetadataType>;
    /**
     ...
     */
    finalizeMotion(motionId: BigNumberish): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").MetaTxCreator<SupportedVotingReputationContract, "finalizeMotion", {
        motionId?: BigNumber | undefined;
     ...
     */
    upgrade(toVersion?: BigNumberish): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").ColonyTxCreator<import("./Colony.js").SupportedColonyContract, "upgradeExtension", {
    ...
    getInitializationOptions(): Promise<{
        ...
        minimumUserStake: BigNumber;
        endVoteThreshold: BigNumber;
        stakePhaseDuration: BigNumber;
        votingPhaseDuration: BigNumber;
        revealPhaseDuration: BigNumber;
        escalationPhaseDuration: BigNumber;
    }>;
}
