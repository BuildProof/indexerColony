...
import { type OneTxPayment as OneTxPaymentContract7, OneTxPayment__factory as OneTxPaymentFactory7 } from '../contracts/OneTxPayment/7/index.js';
import { type OneTxPayment as OneTxPaymentContract8, OneTxPayment__factory as OneTxPaymentFactory8 } from '../contracts/OneTxPayment/8/index.js';
import { type OneTxPayment as OneTxPaymentContract9, OneTxPayment__factory as OneTxPaymentFactory9 } from '../contracts/OneTxPayment/9/index.js';
import { type Colony } from './Colony.js';
export type SupportedOneTxPaymentContract = OneTxPaymentContract7 | OneTxPaymentContract8 | OneTxPaymentContract9;
/**
...
export declare class OneTxPayment {
    ...
    static supportedVersions: ({
        version: number;
        factory: typeof OneTxPaymentFactory7;
    } | {
        version: number;
        factory: typeof OneTxPaymentFactory8;
    } | {
        version: number;
        factory: typeof OneTxPaymentFactory9;
    })[];
    ...
    static getLatestSupportedVersion(): OneTxPaymentVersion;
    /**
     ...
     */
    pay(recipient: string | string[], amount: BigNumberish | BigNumberish[], teamId?: BigNumberish, tokenAddress?: string | string[]): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").ColonyTxCreator<SupportedOneTxPaymentContract, "makePaymentFundedFromDomain", {
