...
export interface OneTxPaymentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "authority" | "authority()" | "deprecate" | "deprecate(bool)" | "executeMetaTransaction" | "executeMetaTransaction(address,bytes,bytes32,bytes32,uint8)" | "finishUpgrade" | "finishUpgrade()" | "getCapabilityRoles" | "getCapabilityRoles(bytes4)" | "getColony" | "getColony()" | "getDeprecated" | "getDeprecated()" | "getMetatransactionNonce" | "getMetatransactionNonce(address)" | "identifier" | "identifier()" | "install" | "install(address)" | "makePayment" | "makePayment(uint256,uint256,uint256,uint256,address[],address[],uint256[],uint256,uint256)" | "makePaymentFundedFromDomain" | "makePaymentFundedFromDomain(uint256,uint256,uint256,uint256,address[],address[],uint256[],uint256,uint256)" | "multicall" | "multicall(bytes[])" | "owner" | "owner()" | "setAuthority" | "setAuthority(address)" | "setOwner" | "setOwner(address)" | "uninstall" | "uninstall()" | "verify" | "verify(address,uint256,uint256,bytes,bytes32,bytes32,uint8)" | "version" | "version()"): FunctionFragment;
