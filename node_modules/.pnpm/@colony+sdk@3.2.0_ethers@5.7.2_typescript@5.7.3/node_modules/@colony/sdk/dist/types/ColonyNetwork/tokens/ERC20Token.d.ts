...
export declare class ERC20Token {
     ...
     */
    transfer(to: string, value: BigNumberish): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").TxCreator<ERC20TokenType, "transfer", {
     ...
     * | `wad` | BigNumber | Amount that was transferred |
     */
    transferFrom(from: string, to: string, value: BigNumberish): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").TxCreator<ERC20TokenType, "transferFrom", {
        src?: string | undefined;
        dst?: string | undefined;
        wad?: BigNumber | undefined;
    }, import("@colony/events").MetadataType>;
     ...
     */
    approve(amount: BigNumberish, spender?: string): import(".pnpm/@colony+sdk@3.2.0_ethers@5.7.2_typescript@5.7.3/node_modules/@colony/sdk").TxCreator<ERC20TokenType, "approve", {
        src?: string | undefined;
