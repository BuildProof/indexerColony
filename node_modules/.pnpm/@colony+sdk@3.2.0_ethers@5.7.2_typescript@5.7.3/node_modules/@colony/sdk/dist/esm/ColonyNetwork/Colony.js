...
import { IColony__factory as ColonyFactory15, } from '../contracts/IColony/15/index.js';
import { IColony__factory as ColonyFactory16, } from '../contracts/IColony/16/index.js';
import { IColony__factory as ColonyFactory17, } from '../contracts/IColony/17/index.js';
...
export class Colony {
    ...
    makeArbitraryTransaction(target, action) {
        return this.createColonyTxCreator(this.colony, 'makeArbitraryTransactions', [[target], [action], false], async (receipt) => ({
            // eslint-disable-next-line max-len
            ...extractEvent('ArbitraryTransaction(address,bytes,bool)', receipt),
        }));
    }
    /**
