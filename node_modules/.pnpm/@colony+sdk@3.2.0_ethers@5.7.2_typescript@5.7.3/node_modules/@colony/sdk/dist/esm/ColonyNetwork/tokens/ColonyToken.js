import { ColonyTokenFactory, } from '@colony/tokens';
...
export class ColonyToken extends ERC20Token {
    ...
    constructor(colonyNetwork, token) {
        ...
        if (typeof token == 'string') {
            this.tokenClient = ColonyTokenFactory.connect(token, colonyNetwork.config.signerOrProvider);
        }
        else {
    ...
    setAuthority(address) {
        return this.colonyNetwork.createMetaTxCreator(this.tokenClient, 'setAuthority', [address], async (receipt) => ({
            ...extractEvent('LogSetAuthority', receipt),
        }));
    }
    /**
     ...
     */
    setOwner(address) {
        return this.colonyNetwork.createMetaTxCreator(this.tokenClient, 'setOwner', [address], async (receipt) => ({
            ...extractEvent('LogSetOwner', receipt),
        }));
    }
}
