...
exports.Colony = exports.SupportedExtension = void 0;
const ethers_1 = require("ethers");
const core_1 = require("@colony/core");
const events_1 = require("@colony/events");
const index_js_1 = require("../contracts/IColony/15/index.js");
const index_js_2 = require("../contracts/IColony/16/index.js");
const index_js_3 = require("../contracts/IColony/17/index.js");
const index_js_4 = require("../TxCreator/index.js");
const utils_js_1 = require("../utils.js");
const OneTxPayment_js_1 = require("./OneTxPayment.js");
const index_js_5 = require("./tokens/index.js");
...
(function (SupportedExtension) {
    ...
    SupportedExtension["motion"] = "motion";
    /** One Transaction Payment (OneTxPayment - enabled by default in Dapp created colonies) */
    SupportedExtension["oneTx"] = "oneTx";
})(SupportedExtension || (exports.SupportedExtension = SupportedExtension = {}));
const supportedExtensionMap = {
    [SupportedExtension.motion]: VotingReputation_js_1.VotingReputation,
    [SupportedExtension.oneTx]: OneTxPayment_js_1.OneTxPayment,
};
class Colony {
    /**
     ...
     */
    static connect(colonyNetwork, address) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const version = (yield (0, core_1.getContractVersion)(address, colonyNetwork.config.signerOrProvider));
            const Factory = (_a = Colony.supportedVersions.find((v) => v.version === version)) === null || _a === void 0 ? void 0 : _a.factory;
            if (!Factory) {
                throw new Error(`Version ${version} of the Colony contract is not supported in the SDK as of now`);
            }
            const colonyContract = Factory.connect(address, colonyNetwork.config.signerOrProvider);
            const tokenAddress = yield colonyContract.getToken();
            const token = yield (0, index_js_5.getToken)(colonyNetwork, tokenAddress);
            const colony = new Colony(colonyNetwork, colonyContract, token, version);
            yield colony.updateExtensions();
            return colony;
        });
    }
    /*
     ...
     */
    constructor(colonyNetwork, colony, token, deployedVersion) {
        this.colony = colony;
        this.colonyNetwork = colonyNetwork;
        this.config = colonyNetwork.config;
        this.address = colony.address;
        this.ext = {};
        this.reputation = new core_1.ReputationClient(colonyNetwork.getInternalNetworkContract(), colony, { customEndpointUrl: colonyNetwork.config.reputationOracleEndpoint });
        this.token = token;
     ...
     */
    createColonyTxCreator(contract, method, args, eventData, txConfig) {
        return new index_js_4.ColonyTxCreator({
            colony: this,
     ...
     */
    createPermissionedColonyTxCreator(contract, method, args, permissionConfig, eventData, txConfig) {
        return new index_js_4.ColonyTxCreator({
            colony: this,
            config: this.colonyNetwork.config,
            contract,
    ...
    updateExtensions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.ext.motions) {
                try {
                    this.ext.motions = yield VotingReputation_js_1.VotingReputation.connect(this);
                }
                catch (e) {
                    if (typeof process != 'undefined' && ((_a = process === null || process === void 0 ? void 0 : process.env) === null || _a === void 0 ? void 0 : _a.DEBUG)) {
                        console.error(e);
                    }
                }
            }
            if (!this.ext.oneTx) {
                try {
                    this.ext.oneTx = yield OneTxPayment_js_1.OneTxPayment.connect(this);
                }
                catch (e) {
                    if (typeof process != 'undefined' && ((_b = process === null || process === void 0 ? void 0 : process.env) === null || _b === void 0 ? void 0 : _b.DEBUG)) {
                        console.error(e);
                    }
                }
            }
    ...
    getBalance(tokenAddress, teamId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (teamId) {
                const { fundingPotId } = yield this.colony.getDomain(teamId);
            ...
            const token = tokenAddress
                ? new index_js_5.ERC20Token(this.colonyNetwork, tokenAddress)
                : this.token;
     ...
     */
    edit(metadata) {
        return this.createColonyTxCreator(this.colony, 'editColony', () => __awaiter(this, void 0, void 0, function* () {
            let cid;
            if (typeof metadata == 'string') {
                cid = metadata;
            }
            else {
                cid = yield this.config.ipfs.uploadMetadata(events_1.MetadataType.Colony, metadata);
            }
            return [cid];
        }), (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('ColonyMetadata', receipt)));
        }), {
    ...
    createTeam(metadata) {
        if (!metadata) {
            return this.createPermissionedColonyTxCreator(this.colony, 'addDomain(uint256,uint256,uint256)', [core_1.Id.RootDomain], {
                roles: core_1.ColonyRole.Architecture,
                domain: core_1.Id.RootDomain,
            }, (receipt) => __awaiter(this, void 0, void 0, function* () {
                return (Object.assign(Object.assign({}, (0, utils_js_1.extractEvent)('DomainAdded', receipt)), (0, utils_js_1.extractEvent)('FundingPotAdded', receipt)));
            }));
        }
        return this.createPermissionedColonyTxCreator(this.colony, 'addDomain(uint256,uint256,uint256,string)', () => __awaiter(this, void 0, void 0, function* () {
            let cid;
            if (typeof metadata == 'string') {
                cid = metadata;
            }
            else {
                cid = yield this.config.ipfs.uploadMetadata(events_1.MetadataType.Domain, metadata);
            }
            return [core_1.Id.RootDomain, cid];
        }), {
            roles: core_1.ColonyRole.Architecture,
            domain: core_1.Id.RootDomain,
        }, (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign(Object.assign(Object.assign({}, (0, utils_js_1.extractEvent)('DomainAdded', receipt)), (0, utils_js_1.extractEvent)('FundingPotAdded', receipt)), (0, utils_js_1.extractEvent)('DomainMetadata', receipt)));
        }), { metadataType: events_1.MetadataType.Domain });
    }
    /**
     ...
     */
    editTeam(metadata) {
        return this.createPermissionedColonyTxCreator(this.colony, 'editDomain', () => __awaiter(this, void 0, void 0, function* () {
            let cid;
            if (typeof metadata == 'string') {
                cid = metadata;
            }
            ...
            return (Object.assign({}, (0, utils_js_1.extractEvent)('DomainMetadata', receipt)));
        }), { metadataType: events_1.MetadataType.Domain });
    }
    /**
     ...
     */
    deprecateTeam(teamId, deprecated) {
        return this.createPermissionedColonyTxCreator(this.colony, 'deprecateDomain', [teamId, deprecated], {
            roles: core_1.ColonyRole.Architecture,
            domain: teamId,
        }, (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('DomainDeprecated', receipt)));
        }));
    }
    /**
    ...
    getTeam(teamId) {
        return __awaiter(this, void 0, void 0, function* () {
            const teamCount = yield this.colony.getDomainCount();
     ...
     */
    claimFunds(tokenAddress) {
        const token = tokenAddress || this.token.address;
        return this.createColonyTxCreator(this.colony, 'claimColonyFunds', [token], (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('ColonyFundsClaimed', receipt)));
        }));
    }
    /**
    ...
    moveFundsToTeam(amount, toTeam, fromTeam, tokenAddress) {
        const parentTeam = core_1.Id.RootDomain;
        const setFromTeam = fromTeam || core_1.Id.RootDomain;
        const setTokenAddress = tokenAddress || this.token.address;
        return this.createColonyTxCreator(this.colony, 
        // eslint-disable-next-line max-len
        'moveFundsBetweenPots(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,address)', () => __awaiter(this, void 0, void 0, function* () {
            const domain = yield this.colony.getDomain(toTeam);
            if (domain.fundingPotId.isZero()) {
                throw new Error(`Team with id ${ethers_1.BigNumber.from(toTeam).toString()} does not exist`);
            }
            // Manual permission proofs are needed here
            const [permissionDomainId, childSkillIndex] = yield (0, core_1.getPermissionProofs)(this.colonyNetwork.getInternalNetworkContract(), this.colony, parentTeam, core_1.ColonyRole.Funding);
            const networkClient = this.colonyNetwork.getInternalNetworkContract();
            const fromChildSkillIndex = yield (0, core_1.getChildIndex)(networkClient, this.colony, parentTeam, setFromTeam);
            const toChildSkillIndex = yield (0, core_1.getChildIndex)(networkClient, this.colony, parentTeam, toTeam);
            const { fundingPotId: fromPot } = yield this.colony.getDomain(setFromTeam);
            const { fundingPotId: toPot } = yield this.colony.getDomain(toTeam);
            return [
                permissionDomainId,
                childSkillIndex,
                parentTeam,
            ...
            return (Object.assign({}, (0, utils_js_1.extractEvent)('ColonyFundsMovedBetweenFundingPots', receipt)));
        }));
    }
    /**
     ...
     */
    getReputation(userAddress_1) {
        return __awaiter(this, arguments, void 0, function* (userAddress, teamId = core_1.Id.RootDomain, decimalPoints = 3) {
            const { skillId } = yield this.colony.getDomain(teamId);
            return this.reputation.getReputationFraction(skillId, userAddress, undefined, decimalPoints);
        });
    }
    /**
     ...
     */
    getReputationPoints(userAddress_1) {
        return __awaiter(this, arguments, void 0, function* (userAddress, teamId = core_1.Id.RootDomain) {
            const { skillId } = yield this.colony.getDomain(teamId);
            const { reputationAmount } = yield this.reputation.getReputation(skillId, userAddress);
     ...
     */
    getReputationAcrossTeams(userAddress) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * **No event data**
     */
    makeArbitraryTransaction(target, action) {
        return this.createColonyTxCreator(this.colony, 'makeArbitraryTransactions', [[target], [action], false], (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('ArbitraryTransaction(address,bytes,bool)', receipt)));
        }));
    }
    /**
     ...
     */
    annotateTransaction(txHash, metadata) {
        return this.createColonyTxCreator(this.colony, 'annotateTransaction', () => __awaiter(this, void 0, void 0, function* () {
            let cid;
            if (typeof metadata == 'string') {
                cid = metadata;
            }
            else {
                cid = yield this.config.ipfs.uploadMetadata(events_1.MetadataType.Annotation, metadata);
            }
            return [txHash, cid];
        }), (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('Annotation', receipt)));
        }), { metadataType: events_1.MetadataType.Annotation });
    }
    /**
    ...
    installExtension(extension) {
        ...
        if (!(0, core_1.isExtensionCompatible)(extensionType, version, this.version)) {
            throw new Error(`v${version} of ${extensionType} extension is not compatible with colony v${this.version}`);
        }
        const networkClient = this.colonyNetwork.getInternalNetworkContract();
        return this.createColonyTxCreator(this.colony, 'installExtension', [(0, core_1.getExtensionHash)(extensionType), Extension.getLatestSupportedVersion()], (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractCustomEvent)('ExtensionInstalled', receipt, networkClient.interface)));
        }));
    }
    /**
     ...
     */
    getRoles(address_1) {
        return __awaiter(this, arguments, void 0, function* (address, teamId = core_1.Id.RootDomain) {
            const roleString = yield this.colony.getUserRoles(address, teamId);
            return (0, core_1.hex2ColonyRoles)(roleString);
        });
    }
    /**
     ...
     */
    setRoles(address, roles, teamId = core_1.Id.RootDomain) {
        return this.createPermissionedColonyTxCreator(this.colony, 'setUserRoles', () => __awaiter(this, void 0, void 0, function* () {
            const oldRoles = yield this.getRoles(address, teamId);
            const newRoles = Array.from(new Set([...oldRoles, ...[].concat(roles)]));
            const hexRoles = (0, core_1.colonyRoles2Hex)(newRoles);
            return [address, teamId, hexRoles];
        }), {
            roles: core_1.ColonyRole.Architecture,
            domain: teamId,
        }, (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign(Object.assign({}, (0, utils_js_1.extractEvent)('ColonyRoleSet', receipt)), (0, utils_js_1.extractEvent)('RecoveryRoleSet', receipt)));
        }));
    }
    /**
     ...
     * | `setTo` | number | Whether the role was awarded or removed |
     */
    unsetRoles(address, roles, teamId = core_1.Id.RootDomain) {
        return this.createPermissionedColonyTxCreator(this.colony, 'setUserRoles', () => __awaiter(this, void 0, void 0, function* () {
            const oldRoles = yield this.getRoles(address, teamId);
            const newRoles = oldRoles.filter((role) => ![].concat(roles).includes(role));
            const hexRoles = (0, core_1.colonyRoles2Hex)(newRoles);
            return [address, teamId, hexRoles];
        }), {
            roles: core_1.ColonyRole.Architecture,
     ...
     */
    mint(amount) {
        return this.createColonyTxCreator(this.colony, 'mintTokens', [amount], (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('TokensMinted', receipt)));
        }));
    }
    /**
     ...
     */
    deployTokenAuthority(allowedToTransfer) {
        const networkClient = this.colonyNetwork.getInternalNetworkContract();
        return this.colonyNetwork.createMetaTxCreator(networkClient, 'deployTokenAuthority', () => __awaiter(this, void 0, void 0, function* () {
            let allowed = [];
            ...
            return [this.token.address, this.address, allowed];
        }), (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('TokenAuthorityDeployed', receipt)));
        }));
    }
    /**
     ...
     */
    enterRecoveryMode() {
        return this.createColonyTxCreator(this.colony, 'enterRecoveryMode', [], (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('RecoveryModeEntered', receipt)));
        }));
    }
    /**
     * Exit Recovery Mode
     ...
     */
    exitRecoveryMode() {
        return this.createColonyTxCreator(this.colony, 'exitRecoveryMode', [], (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('RecoveryModeExited', receipt)));
        }));
    }
    /**
    ...
    upgrade(toVersion) {
        ...
        return this.createColonyTxCreator(this.colony, 'upgrade', [version], (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('ColonyUpgraded', receipt)));
        }));
    }
    /**
     ...
     */
    awardReputation(address, amount, team = core_1.Id.RootDomain) {
        if (ethers_1.BigNumber.from(amount).lte(0)) {
            throw new Error('Reputation award must be bigger than 0');
        }
        return this.createColonyTxCreator(this.colony, 'emitDomainReputationReward', [team, address, amount], (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('ArbitraryReputationUpdate', receipt)));
        }));
    }
    /**
     ...
     */
    smiteReputation(address, amount, team = core_1.Id.RootDomain) {
        if (ethers_1.BigNumber.from(amount).lte(0)) {
            throw new Error('Reputation smite must be bigger than 0');
        }
        return this.createPermissionedColonyTxCreator(this.colony, 'emitDomainReputationPenalty', [team, address, ethers_1.BigNumber.from(0).sub(amount)], {
            domain: team,
            roles: core_1.ColonyRole.Arbitration,
        }, (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('ArbitraryReputationUpdate', receipt)));
        }));
    }
...
Colony.supportedVersions = [
    { version: 15, factory: index_js_1.IColony__factory },
    { version: 16, factory: index_js_2.IColony__factory },
    { version: 17, factory: index_js_3.IColony__factory },
];
