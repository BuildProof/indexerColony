...
export declare class TokenLocking {
     ...
     */
    deposit(tokenAddress: string, amount: BigNumberish): import("../index.js").MetaTxCreator<TokenLockingClient, "deposit(address,uint256,bool)", {
     ...
     */
    withdraw(tokenAddress: string, amount: BigNumberish): import("../index.js").MetaTxCreator<TokenLockingClient, "withdraw(address,uint256,bool)", {
        token?: string | undefined;
        user?: string | undefined;
        amount?: import("ethers").BigNumber | undefined;
    }, import("@colony/events").MetadataType>;
