...
import { type IVotingReputation as VotingReputationContract7, IVotingReputation__factory as VotingReputationFactory7 } from '../contracts/IVotingReputation/7/index.js';
import { type IVotingReputation as VotingReputationContract8, IVotingReputation__factory as VotingReputationFactory8 } from '../contracts/IVotingReputation/8/index.js';
import { type IVotingReputation as VotingReputationContract9 } from '../contracts/IVotingReputation/9/index.js';
import { type Colony } from './Colony.js';
export type SupportedVotingReputationContract = VotingReputationContract7 | VotingReputationContract8 | VotingReputationContract9;
export type Motion = VotingReputationDataTypes7.MotionStructOutput | VotingReputationDataTypes8.MotionStructOutput | VotingReputationDataTypes9.MotionStructOutput;
...
export declare class VotingReputation {
    static supportedVersions: ({
        version: number;
        factory: typeof VotingReputationFactory7;
    } | {
        version: number;
        factory: typeof VotingReputationFactory8;
    })[];
     ...
     */
    initialize(totalStakeFraction: BigNumber, voterRewardFraction: BigNumber, userMinStakeFraction: BigNumber, maxVoteFraction: BigNumber, stakePeriod: number, submitPeriod: number, revealPeriod: number, escalationPeriod: number): import("../index.js").MetaTxCreator<SupportedVotingReputationContract, "initialise", {}, MetadataType>;
    /**
     ...
     */
    createDecision(team?: BigNumberish): import("../index.js").MetaTxCreator<SupportedVotingReputationContract, "createMotion", {
     ...
     */
    annotateDecision(txHash: string, metadata: DecisionData | string): import("../index.js").MetaTxCreator<import("./Colony.js").SupportedColonyContract, "annotateTransaction", {
     ...
     */
    approveStake(amount: BigNumberish, teamId?: BigNumberish): import("../index.js").MetaTxCreator<import("./Colony.js").SupportedColonyContract, "approveStake", {
     ...
     */
    stakeMotion(motionId: BigNumberish, vote: Vote, amount: BigNumberish): import("../index.js").MetaTxCreator<SupportedVotingReputationContract, "stakeMotion", {
        motionId?: BigNumber | undefined;
     ...
     */
    submitVote(motionId: BigNumberish, vote: Vote): import("../index.js").MetaTxCreator<SupportedVotingReputationContract, "submitVote", {
        motionId?: BigNumber | undefined;
     ...
     */
    revealVote(motionId: BigNumberish, vote?: Vote): import("../index.js").MetaTxCreator<SupportedVotingReputationContract, "revealVote", {
        motionId?: BigNumber | undefined;
        voter?: string | undefined;
        vote?: BigNumber | undefined;
    }, MetadataType>;
     ...
     */
    escalateMotion(motionId: BigNumberish, newTeamId: BigNumberish): import("../index.js").MetaTxCreator<SupportedVotingReputationContract, "escalateMotion", {
        motionId?: BigNumber | undefined;
     ...
     */
    finalizeMotion(motionId: BigNumberish): import("../index.js").MetaTxCreator<SupportedVotingReputationContract, "finalizeMotion", {
        motionId?: BigNumber | undefined;
