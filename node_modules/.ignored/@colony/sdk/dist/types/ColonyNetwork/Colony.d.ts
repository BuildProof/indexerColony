...
import { type IColony as ColonyContract11, IColony__factory as ColonyFactory11 } from '../contracts/IColony/11/index.js';
import { type IColony as ColonyContract12 } from '../contracts/IColony/12/index.js';
import { type IColony as ColonyContract13 } from '../contracts/IColony/13/index.js';
...
export type SupportedColonyContract = ColonyContract11 | ColonyContract12 | ColonyContract13;
export type SupportedColonyMethods = SupportedColonyContract['functions'];
export type Domain = ColonyDataTypes10.DomainStructOutput | ColonyDataTypes11.DomainStructOutput | ColonyDataTypes12.DomainStructOutput;
...
export declare class Colony {
    ...
    static supportedVersions: {
        version: number;
        factory: typeof ColonyFactory11;
    }[];
    /**
     ...
     */
    deployTokenAuthority(allowedToTransfer?: string[]): import("../TxCreator/MetaTxCreator.js").MetaTxCreator<import("../contracts/IColonyNetwork.js").IColonyNetwork, "deployTokenAuthority", {
