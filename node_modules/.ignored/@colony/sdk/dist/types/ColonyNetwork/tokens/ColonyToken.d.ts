...
export declare class ColonyToken extends ERC20Token {
     ...
     */
    setAuthority(address: string): import("../../index.js").MetaTxCreator<ColonyTokenType, "setAuthority", {
     ...
     */
    setOwner(address: string): import("../../index.js").MetaTxCreator<ColonyTokenType, "setOwner", {
