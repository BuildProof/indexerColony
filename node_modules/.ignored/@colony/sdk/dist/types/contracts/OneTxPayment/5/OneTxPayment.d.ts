...
export interface OneTxPaymentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "authority" | "authority()" | "executeMetaTransaction" | "executeMetaTransaction(address,bytes,bytes32,bytes32,uint8)" | "getChainId" | "getChainId()" | "getColony" | "getColony()" | "getDeprecated" | "getDeprecated()" | "multicall" | "multicall(bytes[])" | "owner" | "owner()" | "setAuthority" | "setAuthority(address)" | "setOwner" | "setOwner(address)" | "verify" | "verify(address,uint256,uint256,bytes,bytes32,bytes32,uint8)" | "getMetatransactionNonce" | "getMetatransactionNonce(address)" | "identifier" | "identifier()" | "version" | "version()" | "install" | "install(address)" | "finishUpgrade" | "finishUpgrade()" | "deprecate" | "deprecate(bool)" | "uninstall" | "uninstall()" | "getCapabilityRoles" | "getCapabilityRoles(bytes4)" | "makePayment" | "makePayment(uint256,uint256,uint256,uint256,address[],address[],uint256[],uint256,uint256)" | "makePaymentFundedFromDomain" | "makePaymentFundedFromDomain(uint256,uint256,uint256,uint256,address[],address[],uint256[],uint256,uint256)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "makePayment", values: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: "makePayment(uint256,uint256,uint256,uint256,address[],address[],uint256[],uint256,uint256)", values: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: "makePaymentFundedFromDomain", values: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: "makePaymentFundedFromDomain(uint256,uint256,uint256,uint256,address[],address[],uint256[],uint256,uint256)", values: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    decodeFunctionResult(functionFragment: "makePayment(uint256,uint256,uint256,uint256,address[],address[],uint256[],uint256,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "makePaymentFundedFromDomain", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "makePaymentFundedFromDomain(uint256,uint256,uint256,uint256,address[],address[],uint256[],uint256,uint256)", data: BytesLike): Result;
    events: {
    ...
    getEvent(nameOrSignatureOrTopic: "OneTxPaymentMade(address,uint256,uint256)"): EventFragment;
}
...
export type OneTxPaymentMadeEventFilter = TypedEventFilter<OneTxPaymentMadeEvent>;
export interface OneTxPayment extends BaseContract {
    ...
    functions: {
         ...
         */
        makePayment(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _callerPermissionDomainId: BigNumberish, _callerChildSkillIndex: BigNumberish, _workers: string[], _tokens: string[], _amounts: BigNumberish[], _domainId: BigNumberish, _skillId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Assumes that each entity holds administration and funding roles in the root domain
         ...
         * @param _workers The addresses of the recipients of the payment
         */
        "makePayment(uint256,uint256,uint256,uint256,address[],address[],uint256[],uint256,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _callerPermissionDomainId: BigNumberish, _callerChildSkillIndex: BigNumberish, _workers: string[], _tokens: string[], _amounts: BigNumberish[], _domainId: BigNumberish, _skillId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _workers The addresses of the recipients of the payment
         */
        makePaymentFundedFromDomain(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _callerPermissionDomainId: BigNumberish, _callerChildSkillIndex: BigNumberish, _workers: string[], _tokens: string[], _amounts: BigNumberish[], _domainId: BigNumberish, _skillId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Assumes that each entity holds administration and funding roles in the same domain,   although contract and caller can have the permissions in different domains. Payment is taken from domain funds - if the domain does not have sufficient funds, call will fail.
         ...
         * @param _workers The addresses of the recipients of the payment
         */
        "makePaymentFundedFromDomain(uint256,uint256,uint256,uint256,address[],address[],uint256[],uint256,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _callerPermissionDomainId: BigNumberish, _callerChildSkillIndex: BigNumberish, _workers: string[], _tokens: string[], _amounts: BigNumberish[], _domainId: BigNumberish, _skillId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    authority(overrides?: CallOverrides): Promise<string>;
