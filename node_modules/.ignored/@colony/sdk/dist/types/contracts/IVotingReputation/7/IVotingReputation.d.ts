...
export interface IVotingReputationInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "deprecate" | "deprecate(bool)" | "executeMetaTransaction" | "executeMetaTransaction(address,bytes,bytes32,bytes32,uint8)" | "finishUpgrade" | "finishUpgrade()" | "getCapabilityRoles" | "getCapabilityRoles(bytes4)" | "getColony" | "getColony()" | "getDeprecated" | "getDeprecated()" | "getMetatransactionNonce" | "getMetatransactionNonce(address)" | "identifier" | "identifier()" | "install" | "install(address)" | "uninstall" | "uninstall()" | "version" | "version()" | "initialise" | "initialise(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)" | "createMotion" | "createMotion(uint256,uint256,address,bytes,bytes,bytes,uint256,bytes32[])" | "createRootMotion" | "createRootMotion(address,bytes,bytes,bytes,uint256,bytes32[])" | "createDomainMotion" | "createDomainMotion(uint256,uint256,bytes,bytes,bytes,uint256,bytes32[])" | "stakeMotion" | "stakeMotion(uint256,uint256,uint256,uint256,uint256,bytes,bytes,uint256,bytes32[])" | "submitVote" | "submitVote(uint256,bytes32,bytes,bytes,uint256,bytes32[])" | "revealVote" | "revealVote(uint256,bytes32,uint256,bytes,bytes,uint256,bytes32[])" | "escalateMotion" | "escalateMotion(uint256,uint256,uint256,bytes,bytes,uint256,bytes32[])" | "finalizeMotion" | "finalizeMotion(uint256)" | "failingExecutionAllowed" | "failingExecutionAllowed(uint256)" | "claimReward" | "claimReward(uint256,uint256,uint256,address,uint256)" | "getTotalStakeFraction" | "getTotalStakeFraction()" | "getVoterRewardFraction" | "getVoterRewardFraction()" | "getUserMinStakeFraction" | "getUserMinStakeFraction()" | "getMaxVoteFraction" | "getMaxVoteFraction()" | "getStakePeriod" | "getStakePeriod()" | "getSubmitPeriod" | "getSubmitPeriod()" | "getRevealPeriod" | "getRevealPeriod()" | "getEscalationPeriod" | "getEscalationPeriod()" | "getMotionCount" | "getMotionCount()" | "getMotion" | "getMotion(uint256)" | "getStake" | "getStake(uint256,address,uint256)" | "getExpenditureMotionCount" | "getExpenditureMotionCount(bytes32)" | "getExpenditurePastVote" | "getExpenditurePastVote(bytes32)" | "getMotionState" | "getMotionState(uint256)" | "getVoterReward" | "getVoterReward(uint256,uint256)" | "getVoterRewardRange" | "getVoterRewardRange(uint256,uint256,address)" | "getStakerReward" | "getStakerReward(uint256,address,uint256)" | "createClaimDelayAction" | "createClaimDelayAction(bytes,uint256)" | "claimMisalignedReward" | "claimMisalignedReward(uint256,uint256,uint256,address,uint256)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "createRootMotion", values: [string, BytesLike, BytesLike, BytesLike, BigNumberish, BytesLike[]]): string;
    encodeFunctionData(functionFragment: "createRootMotion(address,bytes,bytes,bytes,uint256,bytes32[])", values: [string, BytesLike, BytesLike, BytesLike, BigNumberish, BytesLike[]]): string;
    encodeFunctionData(functionFragment: "createDomainMotion", values: [
        BigNumberish,
        BigNumberish,
        BytesLike,
        BytesLike,
    ...
    encodeFunctionData(functionFragment: "createDomainMotion(uint256,uint256,bytes,bytes,bytes,uint256,bytes32[])", values: [
        BigNumberish,
        BigNumberish,
        BytesLike,
        BytesLike,
    ...
    encodeFunctionData(functionFragment: "getExpenditurePastVote", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "getExpenditurePastVote(bytes32)", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "createClaimDelayAction", values: [BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "createClaimDelayAction(bytes,uint256)", values: [BytesLike, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "createRootMotion", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "createRootMotion(address,bytes,bytes,bytes,uint256,bytes32[])", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "createDomainMotion", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "createDomainMotion(uint256,uint256,bytes,bytes,bytes,uint256,bytes32[])", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getExpenditurePastVote(bytes32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "createClaimDelayAction", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "createClaimDelayAction(bytes,uint256)", data: BytesLike): Result;
...
export interface IVotingReputation extends BaseContract {
    ...
    functions: {
         ...
         * @param _value Reputation tree value for the root domain
         */
        createRootMotion(_altTarget: string, _action: BytesLike, _key: BytesLike, _value: BytesLike, _branchMask: BigNumberish, _siblings: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Create a motion in the root domain (DEPRECATED)
         ...
         * @param _value Reputation tree value for the root domain
         */
        "createRootMotion(address,bytes,bytes,bytes,uint256,bytes32[])"(_altTarget: string, _action: BytesLike, _key: BytesLike, _value: BytesLike, _branchMask: BigNumberish, _siblings: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         */
        createDomainMotion(_domainId: BigNumberish, _childSkillIndex: BigNumberish, _action: BytesLike, _key: BytesLike, _value: BytesLike, _branchMask: BigNumberish, _siblings: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Create a motion in any domain (DEPRECATED)
         ...
         * @param _value Reputation tree value for the domain
         */
        "createDomainMotion(uint256,uint256,bytes,bytes,bytes,uint256,bytes32[])"(_domainId: BigNumberish, _childSkillIndex: BigNumberish, _action: BytesLike, _key: BytesLike, _value: BytesLike, _branchMask: BigNumberish, _siblings: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Stake on a motion
         ...
         */
        createClaimDelayAction(_action: BytesLike, _value: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Not expected to be used directly, could be made private in the future
         ...
         * @param _value The value to set the claim delay to
         */
        "createClaimDelayAction(bytes,uint256)"(_action: BytesLike, _value: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
    ...
    callStatic: {
         ...
         * @param _value The value to set the claim delay to
         */
        "createClaimDelayAction(bytes,uint256)"(_action: BytesLike, _value: BigNumberish, overrides?: CallOverrides): Promise<string>;
        /**
         * Claim the staker's reward from a motion that was created with v4 of the extension, and is now missing and cannot be interacted with via the normal claim function.
         * @param _childSkillIndex For the domain in which the motion is occurring
         * @param _motionId The id of the motion
