...
export interface IVotingReputation extends BaseContract {
    ...
    functions: {
        ...
        multicall(arg0: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "multicall(bytes[])"(arg0: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
