...
export interface IColonyInterface extends utils.Interface {
    functions: {
        ...
        "setExpenditureValues(uint256,uint256[],address[],uint256[],uint256[],uint256[],uint256[],uint256[],int256[],address[],uint256[][],uint256[][])": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "approveExitRecovery" | "approveExitRecovery()" | "checkNotAdditionalProtectedVariable" | "checkNotAdditionalProtectedVariable(uint256)" | "enterRecoveryMode" | "enterRecoveryMode()" | "executeMetaTransaction" | "executeMetaTransaction(address,bytes,bytes32,bytes32,uint8)" | "exitRecoveryMode" | "exitRecoveryMode()" | "getMetatransactionNonce" | "getMetatransactionNonce(address)" | "isInRecoveryMode" | "isInRecoveryMode()" | "multicall" | "multicall(bytes[])" | "numRecoveryRoles" | "numRecoveryRoles()" | "removeRecoveryRole" | "removeRecoveryRole(address)" | "setRecoveryRole" | "setRecoveryRole(address)" | "setStorageSlotRecovery" | "setStorageSlotRecovery(uint256,bytes32)" | "authority" | "authority()" | "owner" | "owner()" | "version" | "version()" | "upgrade" | "upgrade(uint256)" | "finishUpgrade" | "finishUpgrade()" | "getColonyNetwork" | "getColonyNetwork()" | "getToken" | "getToken()" | "makeArbitraryTransaction" | "makeArbitraryTransaction(address,bytes)" | "makeArbitraryTransactions" | "makeArbitraryTransactions(address[],bytes[],bool)" | "makeSingleArbitraryTransaction" | "makeSingleArbitraryTransaction(address,bytes)" | "annotateTransaction" | "annotateTransaction(bytes32,string)" | "setRootRole" | "setRootRole(address,bool)" | "setArbitrationRole" | "setArbitrationRole(uint256,uint256,address,uint256,bool)" | "setArchitectureRole" | "setArchitectureRole(uint256,uint256,address,uint256,bool)" | "setFundingRole" | "setFundingRole(uint256,uint256,address,uint256,bool)" | "setAdministrationRole" | "setAdministrationRole(uint256,uint256,address,uint256,bool)" | "setUserRoles" | "setUserRoles(uint256,uint256,address,uint256,bytes32)" | "hasUserRole" | "hasUserRole(address,uint256,uint8)" | "hasInheritedUserRole" | "hasInheritedUserRole(address,uint256,uint8,uint256,uint256)" | "userCanSetRoles" | "userCanSetRoles(address,uint256,uint256,uint256)" | "getUserRoles" | "getUserRoles(address,uint256)" | "getCapabilityRoles" | "getCapabilityRoles(bytes4)" | "emitDomainReputationReward" | "emitDomainReputationReward(uint256,address,int256)" | "emitSkillReputationReward" | "emitSkillReputationReward(uint256,address,int256)" | "emitDomainReputationPenalty" | "emitDomainReputationPenalty(uint256,uint256,uint256,address,int256)" | "emitSkillReputationPenalty" | "emitSkillReputationPenalty(uint256,address,int256)" | "initialiseColony" | "initialiseColony(address,address)" | "editColony" | "editColony(string)" | "editColonyByDelta" | "editColonyByDelta(string)" | "bootstrapColony" | "bootstrapColony(address[],int256[])" | "mintTokens" | "mintTokens(uint256)" | "mintTokensFor" | "mintTokensFor(address,uint256)" | "lockToken" | "lockToken()" | "unlockTokenForUser" | "unlockTokenForUser(address,uint256)" | "registerColonyLabel" | "registerColonyLabel(string,string)" | "updateColonyOrbitDB" | "updateColonyOrbitDB(string)" | "installExtension" | "installExtension(bytes32,uint256)" | "upgradeExtension" | "upgradeExtension(bytes32,uint256)" | "deprecateExtension" | "deprecateExtension(bytes32,bool)" | "uninstallExtension" | "uninstallExtension(bytes32)" | "initialiseRootLocalSkill" | "initialiseRootLocalSkill()" | "addLocalSkill" | "addLocalSkill()" | "deprecateLocalSkill" | "deprecateLocalSkill(uint256,bool)" | "getRootLocalSkill" | "getRootLocalSkill()" | "addDomain(uint256,uint256,uint256)" | "addDomain(uint256,uint256,uint256,string)" | "editDomain" | "editDomain(uint256,uint256,uint256,string)" | "deprecateDomain" | "deprecateDomain(uint256,uint256,uint256,bool)" | "getDomain" | "getDomain(uint256)" | "getDomainCount" | "getDomainCount()" | "verifyReputationProof" | "verifyReputationProof(bytes,bytes,uint256,bytes32[])" | "setDefaultGlobalClaimDelay" | "setDefaultGlobalClaimDelay(uint256)" | "makeExpenditure" | "makeExpenditure(uint256,uint256,uint256)" | "transferExpenditure" | "transferExpenditure(uint256,address)" | "transferExpenditureViaArbitration" | "transferExpenditureViaArbitration(uint256,uint256,uint256,address)" | "cancelExpenditure" | "cancelExpenditure(uint256)" | "lockExpenditure" | "lockExpenditure(uint256)" | "finalizeExpenditure" | "finalizeExpenditure(uint256)" | "setExpenditureMetadata(uint256,uint256,uint256,string)" | "setExpenditureMetadata(uint256,string)" | "setExpenditureRecipient" | "setExpenditureRecipient(uint256,uint256,address)" | "setExpenditureRecipients" | "setExpenditureRecipients(uint256,uint256[],address[])" | "setExpenditurePayouts" | "setExpenditurePayouts(uint256,uint256[],address,uint256[])" | "setExpenditurePayout(uint256,uint256,address,uint256)" | "setExpenditurePayout(uint256,uint256,uint256,uint256,address,uint256)" | "setExpenditureSkill" | "setExpenditureSkill(uint256,uint256,uint256)" | "setExpenditureSkills" | "setExpenditureSkills(uint256,uint256[],uint256[])" | "setExpenditureClaimDelay" | "setExpenditureClaimDelay(uint256,uint256,uint256)" | "setExpenditureClaimDelays" | "setExpenditureClaimDelays(uint256,uint256[],uint256[])" | "setExpenditurePayoutModifiers" | "setExpenditurePayoutModifiers(uint256,uint256[],int256[])" | "setExpenditureValues" | "setExpenditureValues(uint256,uint256[],address[],uint256[],uint256[],uint256[],uint256[],uint256[],int256[],address[],uint256[][],uint256[][])" | "setExpenditureState" | "setExpenditureState(uint256,uint256,uint256,uint256,bool[],bytes32[],bytes32)" | "claimExpenditurePayout" | "claimExpenditurePayout(uint256,uint256,address)" | "getExpenditureCount" | "getExpenditureCount()" | "getExpenditure" | "getExpenditure(uint256)" | "getExpenditureSlot" | "getExpenditureSlot(uint256,uint256)" | "getExpenditureSlotPayout" | "getExpenditureSlotPayout(uint256,uint256,address)" | "addPayment" | "addPayment(uint256,uint256,address,address,uint256,uint256,uint256)" | "finalizePayment" | "finalizePayment(uint256,uint256,uint256)" | "setPaymentRecipient" | "setPaymentRecipient(uint256,uint256,uint256,address)" | "setPaymentSkill" | "setPaymentSkill(uint256,uint256,uint256,uint256)" | "setPaymentPayout" | "setPaymentPayout(uint256,uint256,uint256,address,uint256)" | "getPayment" | "getPayment(uint256)" | "claimPayment" | "claimPayment(uint256,address)" | "getPaymentCount" | "getPaymentCount()" | "makeTask" | "makeTask(uint256,uint256,bytes32,uint256,uint256,uint256)" | "getTaskCount" | "getTaskCount()" | "getTaskChangeNonce" | "getTaskChangeNonce(uint256)" | "executeTaskChange" | "executeTaskChange(uint8[],bytes32[],bytes32[],uint8[],uint256,bytes)" | "executeTaskRoleAssignment" | "executeTaskRoleAssignment(uint8[],bytes32[],bytes32[],uint8[],uint256,bytes)" | "submitTaskWorkRating" | "submitTaskWorkRating(uint256,uint8,bytes32)" | "revealTaskWorkRating" | "revealTaskWorkRating(uint256,uint8,uint8,bytes32)" | "generateSecret" | "generateSecret(bytes32,uint256)" | "getTaskWorkRatingSecretsInfo" | "getTaskWorkRatingSecretsInfo(uint256)" | "getTaskWorkRatingSecret" | "getTaskWorkRatingSecret(uint256,uint8)" | "setTaskManagerRole" | "setTaskManagerRole(uint256,address,uint256,uint256)" | "setTaskEvaluatorRole" | "setTaskEvaluatorRole(uint256,address)" | "setTaskWorkerRole" | "setTaskWorkerRole(uint256,address)" | "removeTaskEvaluatorRole" | "removeTaskEvaluatorRole(uint256)" | "removeTaskWorkerRole" | "removeTaskWorkerRole(uint256)" | "setTaskSkill" | "setTaskSkill(uint256,uint256)" | "setTaskBrief" | "setTaskBrief(uint256,bytes32)" | "setTaskDueDate" | "setTaskDueDate(uint256,uint256)" | "submitTaskDeliverable" | "submitTaskDeliverable(uint256,bytes32)" | "submitTaskDeliverableAndRating" | "submitTaskDeliverableAndRating(uint256,bytes32,bytes32)" | "finalizeTask" | "finalizeTask(uint256)" | "cancelTask" | "cancelTask(uint256)" | "completeTask" | "completeTask(uint256)" | "getTask" | "getTask(uint256)" | "getTaskRole" | "getTaskRole(uint256,uint8)" | "setRewardInverse" | "setRewardInverse(uint256)" | "getRewardInverse" | "getRewardInverse()" | "getTaskPayout" | "getTaskPayout(uint256,uint8,address)" | "setTaskManagerPayout" | "setTaskManagerPayout(uint256,address,uint256)" | "setTaskEvaluatorPayout" | "setTaskEvaluatorPayout(uint256,address,uint256)" | "setTaskWorkerPayout" | "setTaskWorkerPayout(uint256,address,uint256)" | "setAllTaskPayouts" | "setAllTaskPayouts(uint256,address,uint256,uint256,uint256)" | "claimTaskPayout" | "claimTaskPayout(uint256,uint8,address)" | "startNextRewardPayout" | "startNextRewardPayout(address,bytes,bytes,uint256,bytes32[])" | "claimRewardPayout" | "claimRewardPayout(uint256,uint256[7],bytes,bytes,uint256,bytes32[])" | "getRewardPayoutInfo" | "getRewardPayoutInfo(uint256)" | "finalizeRewardPayout" | "finalizeRewardPayout(uint256)" | "getFundingPot" | "getFundingPot(uint256)" | "getFundingPotCount" | "getFundingPotCount()" | "getFundingPotBalance" | "getFundingPotBalance(uint256,address)" | "getFundingPotPayout" | "getFundingPotPayout(uint256,address)" | "moveFundsBetweenPots(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,address)" | "moveFundsBetweenPots(uint256,uint256,uint256,uint256,uint256,uint256,address)" | "claimColonyFunds" | "claimColonyFunds(address)" | "getNonRewardPotsTotal" | "getNonRewardPotsTotal(address)" | "approveStake" | "approveStake(address,uint256,uint256)" | "obligateStake" | "obligateStake(address,uint256,uint256)" | "deobligateStake" | "deobligateStake(address,uint256,uint256)" | "transferStake" | "transferStake(uint256,uint256,address,address,uint256,uint256,address)" | "getApproval" | "getApproval(address,address,uint256)" | "getObligation" | "getObligation(address,address,uint256)" | "getDomainFromFundingPot" | "getDomainFromFundingPot(uint256)" | "burnTokens" | "burnTokens(address,uint256)" | "unlockToken" | "unlockToken()" | "updateApprovalAmount" | "updateApprovalAmount(address,address)" | "getTokenApproval" | "getTokenApproval(address,address)" | "getTotalTokenApproval" | "getTotalTokenApproval(address)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setExpenditureValues", values: [
        BigNumberish,
        BigNumberish[],
        string[],
        BigNumberish[],
    ...
    encodeFunctionData(functionFragment: "setExpenditureValues(uint256,uint256[],address[],uint256[],uint256[],uint256[],uint256[],uint256[],int256[],address[],uint256[][],uint256[][])", values: [
        BigNumberish,
        BigNumberish[],
        string[],
        BigNumberish[],
    ...
    encodeFunctionData(functionFragment: "addPayment", values: [
        BigNumberish,
        BigNumberish,
        string,
        string,
    ...
    encodeFunctionData(functionFragment: "addPayment(uint256,uint256,address,address,uint256,uint256,uint256)", values: [
        BigNumberish,
        BigNumberish,
        string,
        string,
    ...
    encodeFunctionData(functionFragment: "finalizePayment", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "finalizePayment(uint256,uint256,uint256)", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setPaymentRecipient", values: [BigNumberish, BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "setPaymentRecipient(uint256,uint256,uint256,address)", values: [BigNumberish, BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "setPaymentSkill", values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setPaymentSkill(uint256,uint256,uint256,uint256)", values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setPaymentPayout", values: [BigNumberish, BigNumberish, BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setPaymentPayout(uint256,uint256,uint256,address,uint256)", values: [BigNumberish, BigNumberish, BigNumberish, string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "claimPayment", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "claimPayment(uint256,address)", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "getPaymentCount", values?: undefined): string;
    encodeFunctionData(functionFragment: "getPaymentCount()", values?: undefined): string;
    encodeFunctionData(functionFragment: "makeTask", values: [
        BigNumberish,
        BigNumberish,
        BytesLike,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: "makeTask(uint256,uint256,bytes32,uint256,uint256,uint256)", values: [
        BigNumberish,
        BigNumberish,
        BytesLike,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: "executeTaskChange", values: [
        BigNumberish[],
        BytesLike[],
        BytesLike[],
        BigNumberish[],
    ...
    encodeFunctionData(functionFragment: "executeTaskChange(uint8[],bytes32[],bytes32[],uint8[],uint256,bytes)", values: [
        BigNumberish[],
        BytesLike[],
        BytesLike[],
        BigNumberish[],
    ...
    encodeFunctionData(functionFragment: "executeTaskRoleAssignment", values: [
        BigNumberish[],
        BytesLike[],
        BytesLike[],
        BigNumberish[],
    ...
    encodeFunctionData(functionFragment: "executeTaskRoleAssignment(uint8[],bytes32[],bytes32[],uint8[],uint256,bytes)", values: [
        BigNumberish[],
        BytesLike[],
        BytesLike[],
        BigNumberish[],
    ...
    encodeFunctionData(functionFragment: "submitTaskWorkRating", values: [BigNumberish, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "submitTaskWorkRating(uint256,uint8,bytes32)", values: [BigNumberish, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "revealTaskWorkRating", values: [BigNumberish, BigNumberish, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "revealTaskWorkRating(uint256,uint8,uint8,bytes32)", values: [BigNumberish, BigNumberish, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "generateSecret", values: [BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "generateSecret(bytes32,uint256)", values: [BytesLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "setTaskManagerRole", values: [BigNumberish, string, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskManagerRole(uint256,address,uint256,uint256)", values: [BigNumberish, string, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskEvaluatorRole", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "setTaskEvaluatorRole(uint256,address)", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "setTaskWorkerRole", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "setTaskWorkerRole(uint256,address)", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "removeTaskEvaluatorRole", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "removeTaskEvaluatorRole(uint256)", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "removeTaskWorkerRole", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "removeTaskWorkerRole(uint256)", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskSkill", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskSkill(uint256,uint256)", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskBrief", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "setTaskBrief(uint256,bytes32)", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "setTaskDueDate", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskDueDate(uint256,uint256)", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "submitTaskDeliverable", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "submitTaskDeliverable(uint256,bytes32)", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "submitTaskDeliverableAndRating", values: [BigNumberish, BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "submitTaskDeliverableAndRating(uint256,bytes32,bytes32)", values: [BigNumberish, BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "finalizeTask", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "finalizeTask(uint256)", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "cancelTask", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "cancelTask(uint256)", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "completeTask", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "completeTask(uint256)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "getRewardInverse()", values?: undefined): string;
    encodeFunctionData(functionFragment: "getTaskPayout", values: [BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "getTaskPayout(uint256,uint8,address)", values: [BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "setTaskManagerPayout", values: [BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskManagerPayout(uint256,address,uint256)", values: [BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskEvaluatorPayout", values: [BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskEvaluatorPayout(uint256,address,uint256)", values: [BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskWorkerPayout", values: [BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTaskWorkerPayout(uint256,address,uint256)", values: [BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setAllTaskPayouts", values: [BigNumberish, string, BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setAllTaskPayouts(uint256,address,uint256,uint256,uint256)", values: [BigNumberish, string, BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "claimTaskPayout", values: [BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "claimTaskPayout(uint256,uint8,address)", values: [BigNumberish, BigNumberish, string]): string;
    ...
    decodeFunctionResult(functionFragment: "setExpenditureValues", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setExpenditureValues(uint256,uint256[],address[],uint256[],uint256[],uint256[],uint256[],uint256[],int256[],address[],uint256[][],uint256[][])", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "addPayment(uint256,uint256,address,address,uint256,uint256,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "finalizePayment", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "finalizePayment(uint256,uint256,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setPaymentRecipient", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setPaymentRecipient(uint256,uint256,uint256,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setPaymentSkill", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setPaymentSkill(uint256,uint256,uint256,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setPaymentPayout", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setPaymentPayout(uint256,uint256,uint256,address,uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "claimPayment", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "claimPayment(uint256,address)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "makeTask(uint256,uint256,bytes32,uint256,uint256,uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "executeTaskChange", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "executeTaskChange(uint8[],bytes32[],bytes32[],uint8[],uint256,bytes)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "executeTaskRoleAssignment", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "executeTaskRoleAssignment(uint8[],bytes32[],bytes32[],uint8[],uint256,bytes)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "submitTaskWorkRating", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "submitTaskWorkRating(uint256,uint8,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "revealTaskWorkRating", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "revealTaskWorkRating(uint256,uint8,uint8,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "generateSecret", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "generateSecret(bytes32,uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setTaskManagerRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskManagerRole(uint256,address,uint256,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskEvaluatorRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskEvaluatorRole(uint256,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskWorkerRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskWorkerRole(uint256,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeTaskEvaluatorRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeTaskEvaluatorRole(uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeTaskWorkerRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeTaskWorkerRole(uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskSkill", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskSkill(uint256,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskBrief", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskBrief(uint256,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskDueDate", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskDueDate(uint256,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "submitTaskDeliverable", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "submitTaskDeliverable(uint256,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "submitTaskDeliverableAndRating", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "submitTaskDeliverableAndRating(uint256,bytes32,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "finalizeTask", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "finalizeTask(uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "cancelTask", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "cancelTask(uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "completeTask", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "completeTask(uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getRewardInverse()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getTaskPayout", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getTaskPayout(uint256,uint8,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskManagerPayout", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskManagerPayout(uint256,address,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskEvaluatorPayout", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskEvaluatorPayout(uint256,address,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskWorkerPayout", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTaskWorkerPayout(uint256,address,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setAllTaskPayouts", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setAllTaskPayouts(uint256,address,uint256,uint256,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "claimTaskPayout", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "claimTaskPayout(uint256,uint8,address)", data: BytesLike): Result;
...
export interface IColony extends BaseContract {
    ...
    functions: {
         ...
         * @param _skillIds Ids of the new skills to set
         */
        setExpenditureValues(_id: BigNumberish, _recipientSlots: BigNumberish[], _recipients: string[], _skillIdSlots: BigNumberish[], _skillIds: BigNumberish[], _claimDelaySlots: BigNumberish[], _claimDelays: BigNumberish[], _payoutModifierSlots: BigNumberish[], _payoutModifiers: BigNumberish[], _payoutTokens: string[], _payoutSlots: BigNumberish[][], _payoutValues: BigNumberish[][], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Set many values of an expenditure simultaneously. Can only be called by expenditure owner.
         ...
         * @param _skillIds Ids of the new skills to set
         */
        "setExpenditureValues(uint256,uint256[],address[],uint256[],uint256[],uint256[],uint256[],uint256[],int256[],address[],uint256[][],uint256[][])"(_id: BigNumberish, _recipientSlots: BigNumberish[], _recipients: string[], _skillIdSlots: BigNumberish[], _skillIds: BigNumberish[], _claimDelaySlots: BigNumberish[], _claimDelays: BigNumberish[], _payoutModifierSlots: BigNumberish[], _payoutModifiers: BigNumberish[], _payoutTokens: string[], _payoutSlots: BigNumberish[][], _payoutValues: BigNumberish[][], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        addPayment(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _recipient: string, _token: string, _amount: BigNumberish, _domainId: BigNumberish, _skillId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Add a new payment in the colony. Secured function to authorised members.
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "addPayment(uint256,uint256,address,address,uint256,uint256,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _recipient: string, _token: string, _amount: BigNumberish, _domainId: BigNumberish, _skillId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _permissionDomainId The domainId in which I have the permission to take this action
         */
        finalizePayment(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Finalizes the payment and logs the reputation log updates. Allowed to be called once after payment is fully funded. Secured function to authorised members.
         ...
         * @param _permissionDomainId The domainId in which I have the permission to take this action
         */
        "finalizePayment(uint256,uint256,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _recipient Address of the payment recipient
         */
        setPaymentRecipient(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, _recipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Sets the recipient on an existing payment. Secured function to authorised members.
         ...
         * @param _recipient Address of the payment recipient
         */
        "setPaymentRecipient(uint256,uint256,uint256,address)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, _recipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _skillId Id of the new skill to set
         */
        setPaymentSkill(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, _skillId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Sets the skill on an existing payment. Secured function to authorised members.
         ...
         * @param _skillId Id of the new skill to set
         */
        "setPaymentSkill(uint256,uint256,uint256,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, _skillId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        setPaymentPayout(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Sets the payout for a given token on an existing payment. Secured function to authorised members.
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "setPaymentPayout(uint256,uint256,uint256,address,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        claimPayment(_id: BigNumberish, _token: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Claim the payout in `_token` denomination for payment `_id`. Here the network receives its fee from each payout. Same as for tasks, ether fees go straight to the Meta Colony whereas Token fees go to the Network to be auctioned off.
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "claimPayment(uint256,address)"(_id: BigNumberish, _token: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         */
        makeTask(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _specificationHash: BytesLike, _domainId: BigNumberish, _skillId: BigNumberish, _dueDate: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Make a new task in the colony. Secured function to authorised members.
         ...
         * @param _specificationHash Database identifier where the task specification is stored
         */
        "makeTask(uint256,uint256,bytes32,uint256,uint256,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _specificationHash: BytesLike, _domainId: BigNumberish, _skillId: BigNumberish, _dueDate: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         */
        executeTaskChange(_sigV: BigNumberish[], _sigR: BytesLike[], _sigS: BytesLike[], _mode: BigNumberish[], _value: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * The Colony functions which require approval and the task roles to review these are set in `IColony.initialiseColony` at colony creation. Upon successful execution the `taskChangeNonces` entry for the task is incremented.
         ...
         * @param _value The transaction value, i.e. number of wei to be sent when the transaction is executed Currently we only accept 0 value transactions but this is kept as a future option
         */
        "executeTaskChange(uint8[],bytes32[],bytes32[],uint8[],uint256,bytes)"(_sigV: BigNumberish[], _sigR: BytesLike[], _sigS: BytesLike[], _mode: BigNumberish[], _value: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _value The transaction value, i.e. number of wei to be sent when the transaction is executed Currently we only accept 0 value transactions but this is kept as a future option
         */
        executeTaskRoleAssignment(_sigV: BigNumberish[], _sigR: BytesLike[], _sigS: BytesLike[], _mode: BigNumberish[], _value: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Executes a task role update transaction `_data` which is approved and signed by two of addresses. depending of which function we are calling. Allowed functions are `setTaskManagerRole`, `setTaskEvaluatorRole` and `setTaskWorkerRole`. Upon successful execution the `taskChangeNonces` entry for the task is incremented.
         ...
         * @param _value The transaction value, i.e. number of wei to be sent when the transaction is executed Currently we only accept 0 value transactions but this is kept as a future option
         */
        "executeTaskRoleAssignment(uint8[],bytes32[],bytes32[],uint8[],uint256,bytes)"(_sigV: BigNumberish[], _sigR: BytesLike[], _sigS: BytesLike[], _mode: BigNumberish[], _value: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         */
        submitTaskWorkRating(_id: BigNumberish, _role: BigNumberish, _ratingSecret: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Submit a hashed secret of the rating for work in task `_id` which was performed by user with task role id `_role`. Allowed within 5 days period starting which whichever is first from either the deliverable being submitted or the dueDate been reached. Allowed only for evaluator to rate worker and for worker to rate manager performance. Once submitted ratings can not be changed or overwritten.
         ...
         * @param _role Id of the role, as defined in TaskRole enum
         */
        "submitTaskWorkRating(uint256,uint8,bytes32)"(_id: BigNumberish, _role: BigNumberish, _ratingSecret: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         */
        revealTaskWorkRating(_id: BigNumberish, _role: BigNumberish, _rating: BigNumberish, _salt: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Compares the `keccak256(_salt, _rating)` output with the previously submitted rating secret and if they match, sets the task role properties `rated` to `true` and `rating` to `_rating`.
         ...
         * @param _salt Salt value used to generate the rating secret
         */
        "revealTaskWorkRating(uint256,uint8,uint8,bytes32)"(_id: BigNumberish, _role: BigNumberish, _rating: BigNumberish, _salt: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _value Value to hide
         */
        "generateSecret(bytes32,uint256)"(_salt: BytesLike, _value: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            secret: string;
        }>;
        /**
         ...
         */
        setTaskManagerRole(_id: BigNumberish, _user: string, _permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * This function can only be called through `executeTaskRoleAssignment`.
         ...
         * @param _user Address of the user we want to give a manager role to
         */
        "setTaskManagerRole(uint256,address,uint256,uint256)"(_id: BigNumberish, _user: string, _permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * This function can only be called through `executeTaskRoleAssignment`.
         ...
         */
        setTaskEvaluatorRole(_id: BigNumberish, _user: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * This function can only be called through `executeTaskRoleAssignment`.
         ...
         * @param _user Address of the user we want to give a evaluator role to
         */
        "setTaskEvaluatorRole(uint256,address)"(_id: BigNumberish, _user: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * This function can only be called through `executeTaskRoleAssignment`.
         ...
         */
        setTaskWorkerRole(_id: BigNumberish, _user: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * This function can only be called through `executeTaskRoleAssignment`.
         ...
         * @param _user Address of the user we want to give a worker role to
         */
        "setTaskWorkerRole(uint256,address)"(_id: BigNumberish, _user: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _id Id of the task
         */
        removeTaskEvaluatorRole(_id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Removing evaluator role. Agreed between manager and currently assigned evaluator.
         * @param _id Id of the task
         */
        "removeTaskEvaluatorRole(uint256)"(_id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _id Id of the task
         */
        removeTaskWorkerRole(_id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Removing worker role. Agreed between manager and currently assigned worker.
         * @param _id Id of the task
         */
        "removeTaskWorkerRole(uint256)"(_id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         */
        setTaskSkill(_id: BigNumberish, _skillId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Currently we only allow one skill per task although we have provisioned for an array of skills in `Task` struct. Allowed before a task is finalized.
         ...
         * @param _skillId Id of the skill which has to be a global skill
         */
        "setTaskSkill(uint256,uint256)"(_id: BigNumberish, _skillId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         */
        setTaskBrief(_id: BigNumberish, _specificationHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Set the hash for the task brief, aka task work specification, which identifies the task brief content in ddb. Allowed before a task is finalized.
         ...
         * @param _specificationHash Unique hash of the task brief in ddb
         */
        "setTaskBrief(uint256,bytes32)"(_id: BigNumberish, _specificationHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _id Id of the task
         */
        setTaskDueDate(_id: BigNumberish, _dueDate: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Set the due date on task `_id`. Allowed before a task is finalized.
         ...
         * @param _id Id of the task
         */
        "setTaskDueDate(uint256,uint256)"(_id: BigNumberish, _dueDate: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _id Id of the task
         */
        submitTaskDeliverable(_id: BigNumberish, _deliverableHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Set the `task.deliverableHash` and `task.completionTimestamp` properties.
         ...
         * @param _id Id of the task
         */
        "submitTaskDeliverable(uint256,bytes32)"(_id: BigNumberish, _deliverableHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         */
        submitTaskDeliverableAndRating(_id: BigNumberish, _deliverableHash: BytesLike, _ratingSecret: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Internally call `submitTaskDeliverable` and `submitTaskWorkRating` in sequence.
         ...
         * @param _ratingSecret Rating secret for manager
         */
        "submitTaskDeliverableAndRating(uint256,bytes32,bytes32)"(_id: BigNumberish, _deliverableHash: BytesLike, _ratingSecret: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _id Id of the task
         */
        finalizeTask(_id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Set the `task.finalized` property to true
         ...
         * @param _id Id of the task
         */
        "finalizeTask(uint256)"(_id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _id Id of the task
         */
        cancelTask(_id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Set the `task.status` property to `1`.
         ...
         * @param _id Id of the task
         */
        "cancelTask(uint256)"(_id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _id Id of the task
         */
        completeTask(_id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Mark a task as complete after the due date has passed. This allows the task to be rated and finalized (and funds recovered) even in the presence of a worker who has disappeared. Note that if the due date was not set, then this function will throw.
         * @param _id Id of the task
         */
        "completeTask(uint256)"(_id: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "getTaskPayout(uint256,uint8,address)"(_id: BigNumberish, _role: BigNumberish, _token: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            amount: BigNumber;
        }>;
        /**
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        setTaskManagerPayout(_id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Set `_token` payout for manager in task `_id` to `_amount`.
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "setTaskManagerPayout(uint256,address,uint256)"(_id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        setTaskEvaluatorPayout(_id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Set `_token` payout for evaluator in task `_id` to `_amount`.
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "setTaskEvaluatorPayout(uint256,address,uint256)"(_id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        setTaskWorkerPayout(_id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Set `_token` payout for worker in task `_id` to `_amount`.
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "setTaskWorkerPayout(uint256,address,uint256)"(_id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         */
        setAllTaskPayouts(_id: BigNumberish, _token: string, _managerAmount: BigNumberish, _evaluatorAmount: BigNumberish, _workerAmount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Can only call if evaluator and worker are unassigned or manager, otherwise need signature.
         ...
         * @param _workerAmount Payout amount for worker
         */
        "setAllTaskPayouts(uint256,address,uint256,uint256,uint256)"(_id: BigNumberish, _token: string, _managerAmount: BigNumberish, _evaluatorAmount: BigNumberish, _workerAmount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        claimTaskPayout(_id: BigNumberish, _role: BigNumberish, _token: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
         * Claim the payout in `_token` denomination for work completed in task `_id` by contributor with role `_role`. Allowed only after task is finalized. Here the network receives its fee from each payout. Ether fees go straight to the Meta Colony whereas Token fees go to the Network to be auctioned off.
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "claimTaskPayout(uint256,uint8,address)"(_id: BigNumberish, _role: BigNumberish, _token: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        /**
    ...
    callStatic: {
         ...
         * @param _skillIds Ids of the new skills to set
         */
        setExpenditureValues(_id: BigNumberish, _recipientSlots: BigNumberish[], _recipients: string[], _skillIdSlots: BigNumberish[], _skillIds: BigNumberish[], _claimDelaySlots: BigNumberish[], _claimDelays: BigNumberish[], _payoutModifierSlots: BigNumberish[], _payoutModifiers: BigNumberish[], _payoutTokens: string[], _payoutSlots: BigNumberish[][], _payoutValues: BigNumberish[][], overrides?: CallOverrides): Promise<void>;
        /**
         * Set many values of an expenditure simultaneously. Can only be called by expenditure owner.
         * @param _claimDelaySlots Array of slots to set claim delays
         * @param _claimDelays Durations of time (in seconds) to delay
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "addPayment(uint256,uint256,address,address,uint256,uint256,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _recipient: string, _token: string, _amount: BigNumberish, _domainId: BigNumberish, _skillId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        /**
         * Finalizes the payment and logs the reputation log updates. Allowed to be called once after payment is fully funded. Secured function to authorised members.
         * @param _childSkillIndex The index that the `_domainId` is relative to `_permissionDomainId`
         * @param _id Payment identifier
         ...
         * @param _permissionDomainId The domainId in which I have the permission to take this action
         */
        "finalizePayment(uint256,uint256,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Sets the recipient on an existing payment. Secured function to authorised members.
         * @param _childSkillIndex The index that the `_domainId` is relative to `_permissionDomainId`
         * @param _id Payment identifier
         ...
         * @param _recipient Address of the payment recipient
         */
        "setPaymentRecipient(uint256,uint256,uint256,address)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, _recipient: string, overrides?: CallOverrides): Promise<void>;
        /**
         * Sets the skill on an existing payment. Secured function to authorised members.
         * @param _childSkillIndex The index that the `_domainId` is relative to `_permissionDomainId`
         * @param _id Payment identifier
         ...
         * @param _skillId Id of the new skill to set
         */
        "setPaymentSkill(uint256,uint256,uint256,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, _skillId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Sets the payout for a given token on an existing payment. Secured function to authorised members.
         * @param _amount Payout amount
         * @param _childSkillIndex The index that the `_domainId` is relative to `_permissionDomainId`
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "setPaymentPayout(uint256,uint256,uint256,address,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Returns an exiting payment.
         * @param _id Payment identifier
         */
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "claimPayment(uint256,address)"(_id: BigNumberish, _token: string, overrides?: CallOverrides): Promise<void>;
        /**
         * Get the number of payments in the colony.
         */
        getPaymentCount(overrides?: CallOverrides): Promise<BigNumber>;
         ...
         * @param _specificationHash Database identifier where the task specification is stored
         */
        "makeTask(uint256,uint256,bytes32,uint256,uint256,uint256)"(_permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, _specificationHash: BytesLike, _domainId: BigNumberish, _skillId: BigNumberish, _dueDate: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Get the number of tasks in the colony.
         */
        getTaskCount(overrides?: CallOverrides): Promise<BigNumber>;
         ...
         * @param _value The transaction value, i.e. number of wei to be sent when the transaction is executed Currently we only accept 0 value transactions but this is kept as a future option
         */
        "executeTaskChange(uint8[],bytes32[],bytes32[],uint8[],uint256,bytes)"(_sigV: BigNumberish[], _sigR: BytesLike[], _sigS: BytesLike[], _mode: BigNumberish[], _value: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
        /**
         * Executes a task role update transaction `_data` which is approved and signed by two of addresses. depending of which function we are calling. Allowed functions are `setTaskManagerRole`, `setTaskEvaluatorRole` and `setTaskWorkerRole`. Upon successful execution the `taskChangeNonces` entry for the task is incremented.
         * @param _data The transaction data
         * @param _mode How the signature was generated - 0 for Geth-style (usual), 1 for Trezor-style (only Trezor does this)
         ...
         * @param _value The transaction value, i.e. number of wei to be sent when the transaction is executed Currently we only accept 0 value transactions but this is kept as a future option
         */
        "executeTaskRoleAssignment(uint8[],bytes32[],bytes32[],uint8[],uint256,bytes)"(_sigV: BigNumberish[], _sigR: BytesLike[], _sigS: BytesLike[], _mode: BigNumberish[], _value: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
        /**
         * Submit a hashed secret of the rating for work in task `_id` which was performed by user with task role id `_role`. Allowed within 5 days period starting which whichever is first from either the deliverable being submitted or the dueDate been reached. Allowed only for evaluator to rate worker and for worker to rate manager performance. Once submitted ratings can not be changed or overwritten.
         * @param _id Id of the task
         * @param _ratingSecret `keccak256` hash of a salt and 0-50 rating score (in increments of 10, .e.g 0, 10, 20, 30, 40 or 50). Can be generated via `IColony.generateSecret` helper function.
         ...
         * @param _role Id of the role, as defined in TaskRole enum
         */
        "submitTaskWorkRating(uint256,uint8,bytes32)"(_id: BigNumberish, _role: BigNumberish, _ratingSecret: BytesLike, overrides?: CallOverrides): Promise<void>;
        /**
         * Compares the `keccak256(_salt, _rating)` output with the previously submitted rating secret and if they match, sets the task role properties `rated` to `true` and `rating` to `_rating`.
         * Reveal the secret rating submitted in `IColony.submitTaskWorkRating` for task `_id` and task role with id `_role`. Allowed within 5 days period starting which whichever is first from either both rating secrets being submitted (via `IColony.submitTaskWorkRating`) or the 5 day rating period expiring.
         * @param _id Id of the task
         ...
         * @param _salt Salt value used to generate the rating secret
         */
        "revealTaskWorkRating(uint256,uint8,uint8,bytes32)"(_id: BigNumberish, _role: BigNumberish, _rating: BigNumberish, _salt: BytesLike, overrides?: CallOverrides): Promise<void>;
        /**
         * Helper function used to generage consistently the rating secret using salt value `_salt` and value to hide `_value`
         * @param _salt Salt value
         * @param _value Value to hide
         ...
         * @param _user Address of the user we want to give a manager role to
         */
        "setTaskManagerRole(uint256,address,uint256,uint256)"(_id: BigNumberish, _user: string, _permissionDomainId: BigNumberish, _childSkillIndex: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * This function can only be called through `executeTaskRoleAssignment`.
         * Assigning evaluator role. Can only be set if there is no one currently assigned to be an evaluator. Manager of the task and user we want to assign role to both need to agree. Managers can assign themselves to this role, if there is no one currently assigned to it.
         * @param _id Id of the task
         ...
         * @param _user Address of the user we want to give a evaluator role to
         */
        "setTaskEvaluatorRole(uint256,address)"(_id: BigNumberish, _user: string, overrides?: CallOverrides): Promise<void>;
        /**
         * This function can only be called through `executeTaskRoleAssignment`.
         * Assigning worker role. Can only be set if there is no one currently assigned to be a worker. Manager of the task and user we want to assign role to both need to agree.
         * @param _id Id of the task
         ...
         * @param _user Address of the user we want to give a worker role to
         */
        "setTaskWorkerRole(uint256,address)"(_id: BigNumberish, _user: string, overrides?: CallOverrides): Promise<void>;
        /**
         * Removing evaluator role. Agreed between manager and currently assigned evaluator.
         * @param _id Id of the task
         */
         ...
         * @param _id Id of the task
         */
        "removeTaskEvaluatorRole(uint256)"(_id: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Removing worker role. Agreed between manager and currently assigned worker.
         * @param _id Id of the task
         */
         ...
         * @param _id Id of the task
         */
        "removeTaskWorkerRole(uint256)"(_id: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Currently we only allow one skill per task although we have provisioned for an array of skills in `Task` struct. Allowed before a task is finalized.
         * Set the skill for task `_id`.
         * @param _id Id of the task
         ...
         * @param _skillId Id of the skill which has to be a global skill
         */
        "setTaskSkill(uint256,uint256)"(_id: BigNumberish, _skillId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Set the hash for the task brief, aka task work specification, which identifies the task brief content in ddb. Allowed before a task is finalized.
         * @param _id Id of the task
         * @param _specificationHash Unique hash of the task brief in ddb
         ...
         * @param _specificationHash Unique hash of the task brief in ddb
         */
        "setTaskBrief(uint256,bytes32)"(_id: BigNumberish, _specificationHash: BytesLike, overrides?: CallOverrides): Promise<void>;
        /**
         * Set the due date on task `_id`. Allowed before a task is finalized.
         * @param _dueDate Due date as seconds since unix epoch
         * @param _id Id of the task
         ...
         * @param _id Id of the task
         */
        "setTaskDueDate(uint256,uint256)"(_id: BigNumberish, _dueDate: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Set the `task.deliverableHash` and `task.completionTimestamp` properties.
         * Submit the task deliverable, i.e. the output of the work performed for task `_id`. Submission is allowed only to the assigned worker before the task due date. Submissions cannot be overwritten.
         * @param _deliverableHash Unique hash of the task deliverable content in ddb
         ...
         * @param _id Id of the task
         */
        "submitTaskDeliverable(uint256,bytes32)"(_id: BigNumberish, _deliverableHash: BytesLike, overrides?: CallOverrides): Promise<void>;
        /**
         * Internally call `submitTaskDeliverable` and `submitTaskWorkRating` in sequence.
         * Submit the task deliverable for Worker and rating for Manager.
         * @param _deliverableHash Unique hash of the task deliverable content in ddb
         ...
         * @param _ratingSecret Rating secret for manager
         */
        "submitTaskDeliverableAndRating(uint256,bytes32,bytes32)"(_id: BigNumberish, _deliverableHash: BytesLike, _ratingSecret: BytesLike, overrides?: CallOverrides): Promise<void>;
        /**
         * Set the `task.finalized` property to true
         * Called after task work rating is complete which closes the task and logs the respective reputation log updates. Allowed to be called once per task. Secured function to authorised members.
         * @param _id Id of the task
         ...
         * @param _id Id of the task
         */
        "finalizeTask(uint256)"(_id: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Set the `task.status` property to `1`.
         * Cancel a task at any point before it is finalized. Secured function to authorised members. Any funds assigned to its funding pot can be moved back to the domain via `IColony.moveFundsBetweenPots`.
         * @param _id Id of the task
         ...
         * @param _id Id of the task
         */
        "cancelTask(uint256)"(_id: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Mark a task as complete after the due date has passed. This allows the task to be rated and finalized (and funds recovered) even in the presence of a worker who has disappeared. Note that if the due date was not set, then this function will throw.
         * @param _id Id of the task
         */
         ...
         * @param _id Id of the task
         */
        "completeTask(uint256)"(_id: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Get a task with id `_id`
         * @param _id Id of the task
         */
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "setTaskManagerPayout(uint256,address,uint256)"(_id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Set `_token` payout for evaluator in task `_id` to `_amount`.
         * @param _amount Payout amount
         * @param _id Id of the task
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "setTaskEvaluatorPayout(uint256,address,uint256)"(_id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Set `_token` payout for worker in task `_id` to `_amount`.
         * @param _amount Payout amount
         * @param _id Id of the task
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "setTaskWorkerPayout(uint256,address,uint256)"(_id: BigNumberish, _token: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Can only call if evaluator and worker are unassigned or manager, otherwise need signature.
         * Set `_token` payout for all roles in task `_id` to the respective amounts.
         * @param _evaluatorAmount Payout amount for evaluator
         ...
         * @param _workerAmount Payout amount for worker
         */
        "setAllTaskPayouts(uint256,address,uint256,uint256,uint256)"(_id: BigNumberish, _token: string, _managerAmount: BigNumberish, _evaluatorAmount: BigNumberish, _workerAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Claim the payout in `_token` denomination for work completed in task `_id` by contributor with role `_role`. Allowed only after task is finalized. Here the network receives its fee from each payout. Ether fees go straight to the Meta Colony whereas Token fees go to the Network to be auctioned off.
         * @param _id Id of the task
         * @param _role Id of the role, as defined in TaskRole enum
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "claimTaskPayout(uint256,uint8,address)"(_id: BigNumberish, _role: BigNumberish, _token: string, overrides?: CallOverrides): Promise<void>;
        /**
         * Start next reward payout for `_token`. All funds in the reward pot for `_token` will become unavailable.Add a new payment in the colony. Can only be called by users with root permission. All tokens will be locked, and can be unlocked by calling `waiveRewardPayout` or `claimRewardPayout`.
         * @param _token Address of the token used for reward payout
         * @param branchMask The branchmask of the proof
    ...
    filters: {
        ...
        "PayoutClaimed(address,uint256,address,uint256)"(agent?: null, fundingPotId?: BigNumberish | null, token?: null, amount?: null): PayoutClaimedEventFilter;
        PayoutClaimed(agent?: null, fundingPotId?: BigNumberish | null, token?: null, amount?: null): PayoutClaimedEventFilter;
    ...
    estimateGas: {
         ...
         * @param _value Value to hide
         */
        generateSecret(_salt: BytesLike, _value: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        /**
         * Helper function used to generage consistently the rating secret using salt value `_salt` and value to hide `_value`
         * @param _salt Salt value
         * @param _value Value to hide
         */
        "generateSecret(bytes32,uint256)"(_salt: BytesLike, _value: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        /**
         * Get the `ColonyStorage.RatingSecrets` information for task `_id`.
         * @param _id Id of the task
         */
    ...
    populateTransaction: {
         ...
         * @param _value Value to hide
         */
        "generateSecret(bytes32,uint256)"(_salt: BytesLike, _value: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        /**
         * Get the `ColonyStorage.RatingSecrets` information for task `_id`.
         * @param _id Id of the task
         */
         ...
         * @param _token Address of the token, `0x0` value indicates Ether
         */
        "getTaskPayout(uint256,uint8,address)"(_id: BigNumberish, _role: BigNumberish, _token: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        /**
         * Set `_token` payout for manager in task `_id` to `_amount`.
         * @param _amount Payout amount
         * @param _id Id of the task
