...
const index_js_1 = require("../contracts/IColony/11/index.js");
const index_js_2 = require("../contracts/IColony/12/index.js");
const index_js_3 = require("../contracts/IColony/13/index.js");
...
class Colony {
     ...
     */
    getReputation(userAddress, teamId = core_1.Id.RootDomain, decimalPoints = 3) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    getReputationPoints(userAddress, teamId = core_1.Id.RootDomain) {
        return __awaiter(this, void 0, void 0, function* () {
            const { skillId } = yield this.colony.getDomain(teamId);
    ...
    makeArbitraryTransaction(target, action) {
        return this.createColonyTxCreator(this.colony, 'makeArbitraryTransactions', [[target], [action], false], (receipt) => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign({}, (0, utils_js_1.extractEvent)('ArbitraryTransaction(address,address,bytes,bool)', receipt)));
        }));
    }
    /**
     ...
     */
    getRoles(address, teamId = core_1.Id.RootDomain) {
        return __awaiter(this, void 0, void 0, function* () {
...
Colony.supportedVersions = [
    { version: 11, factory: index_js_1.IColony__factory },
    { version: 12, factory: index_js_2.IColony__factory },
    { version: 13, factory: index_js_3.IColony__factory },
];
