...
export class ERC20Token {
    ...
    constructor(colonyNetwork, token) {
        if (typeof token == 'string') {
            this.tokenClient = ERC20TokenFactory.connect(token, colonyNetwork.config.signerOrProvider);
        }
        else {
     ...
     */
    transfer(to, value) {
        return this.colonyNetwork.createTxCreator(this.tokenClient, 'transfer', [to, value], async (receipt) => ({
            ...extractEvent('Transfer', receipt),
        }));
    }
    /**
    ...
    transferFrom(from, to, value) {
        return this.colonyNetwork.createTxCreator(this.tokenClient, 'transferFrom', [from, to, value], async (receipt) => ({
            ...extractEvent('Transfer', receipt),
        }));
    }
    /**
    ...
    approve(amount, spender) {
        return this.colonyNetwork.createTxCreator(this.tokenClient, 'approve', async () => {
