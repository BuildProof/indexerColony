...
export interface TokenSupplierEventsInterface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "TokenIssuanceRateSet(uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "TokenSupplyCeilingSet"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "TokenSupplyCeilingSet(uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "TokensIssued"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "TokensIssued(uint256)"): EventFragment;
...
export type TokenIssuanceRateSetEventFilter = TypedEventFilter<TokenIssuanceRateSetEvent>;
...
export type TokenSupplyCeilingSetEventFilter = TypedEventFilter<TokenSupplyCeilingSetEvent>;
