...
export interface CoinMachineEventsInterface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "PeriodUpdated(uint256,uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "TokensBought(address,uint256,uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "TokensBought(address,address,uint256,uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "PriceEvolutionSet"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "PriceEvolutionSet(bool)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "WhitelistSet"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "WhitelistSet(address)"): EventFragment;
...
export type TokensBought_address_uint256_uint256_EventFilter = TypedEventFilter<TokensBought_address_uint256_uint256_Event>;
...
export type TokensBought_address_address_uint256_uint256_EventFilter = TypedEventFilter<TokensBought_address_address_uint256_uint256_Event>;
...
export type PriceEvolutionSetEventFilter = TypedEventFilter<PriceEvolutionSetEvent>;
...
export interface CoinMachineEvents extends BaseContract {
    ...
    filters: {
        ...
        "TokensBought(address,uint256,uint256)"(buyer?: null, numTokens?: null, totalCost?: null): TokensBought_address_uint256_uint256_EventFilter;
        "TokensBought(address,address,uint256,uint256)"(buyer?: string | null, token?: null, numTokens?: null, totalCost?: null): TokensBought_address_address_uint256_uint256_EventFilter;
