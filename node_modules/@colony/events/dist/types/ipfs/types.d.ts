...
export type Data = AnnotationData | ColonyData | DecisionData | DomainData | MiscData;
export type Metadata = AnnotationMetadata | ColonyMetadata | DecisionMetadata | DomainMetadata | MiscMetadata;
