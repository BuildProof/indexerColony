...
export interface TokenSAIInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "name" | "name()" | "approve" | "approve(address,uint256)" | "totalSupply" | "totalSupply()" | "transferFrom" | "transferFrom(address,address,uint256)" | "decimals" | "decimals()" | "balanceOf" | "balanceOf(address)" | "symbol" | "symbol()" | "transfer" | "transfer(address,uint256)" | "allowance" | "allowance(address,address)"): FunctionFragment;
...
export interface TokenSAI extends BaseContract {
    ...
    functions: {
        ...
        "approve(address,uint256)"(_spender: string, _value: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "transferFrom(address,address,uint256)"(_from: string, _to: string, _value: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "transfer(address,uint256)"(_to: string, _value: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
