...
import { ColonyRole, FundingPotAssociatedType, Id, } from '../constants.js';
 ...
 */
export const addressesAreEqual = (a, b) => a.toLowerCase() === b.toLowerCase();
/**
 ...
 * ```
 */
export const toEth = (num) => utils.formatEther(num);
/**
 ...
 * ```
 */
export const toWei = (num) => utils.parseEther(num);
/**
 ...
 * ```
 */
export const w = (str) => toWei(str[0]);
/**
 ...
 */
export const colonyRoles2Hex = (roles) => {
 ...
 */
export const hex2ColonyRoles = (hexStr) => {
 ...
 */
export const getChildIndex = async (network, colony, parentDomainId, domainId) => {
 ...
 */
export const getExtensionHash = (extension) => keccak256(toUtf8Bytes(extension));
/**
 ...
 */
export const getPotDomain = async (colony, potId) => {
    const { associatedType, associatedTypeId } = await colony.getFundingPot(potId);
 ...
 */
export const getBlockTime = async (blockHash, provider) => {
 ...
 */
export const getContractVersion = async (address, signerOrProvider) => {
 ...
 */
export const parseLogs = (logs, iface) => {
    return logs
        .map((log) => {
        try {
