...
(function (MetadataFactory) {
    ...
    MetadataFactory.generate = function (checker, collection, type, options) { return MetadataFactory.analyze(checker)(options)(collection)(type); };
