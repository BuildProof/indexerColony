...
(function (IsProgrammer) {
        ...
        return function (importer) { return ({
            ...
            atomist: function () { return function (entry) { return function () {
                return __spreadArray([
                    entry.expression
                ], __read(entry.tags.map(function (tag) { return tag.expression; })), false).reduce(function (x, y) { return typescript_1.default.factory.createLogicalAnd(x, y); });
            }; }; },
                    ...
                    if (target.size() === 1 &&
                        ...
                        if (obj._Is_simple() &&
                            ...
                            return typescript_1.default.factory.createLogicalAnd(ExpressionFactory_1.ExpressionFactory.isObject({
                                checkNull: true,
                                checkArray: false,
                            })(input), config.joiner.object(input, (0, feature_object_entries_1.feature_object_entries)(config)(importer)(obj)(input)));
                    }
    ...
    IsProgrammer.write_functors = function (project) { return function (importer) {
        return CheckerProgrammer_1.CheckerProgrammer.write_functors(project)(IsProgrammer.configure()(importer))(importer);
    }; };
    IsProgrammer.write_unioners = function (project) { return function (importer) {
        return CheckerProgrammer_1.CheckerProgrammer.write_unioners(project, IsProgrammer.configure()(importer), importer);
    }; };
