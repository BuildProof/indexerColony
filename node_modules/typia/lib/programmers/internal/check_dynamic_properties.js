        ...
        return function (input, regular, dynamic) {
            ...
            var left = props.equals === true && dynamic.length === 0
                ? props.undefined === true ||
                    ...
                    ? typescript_1.default.factory.createStrictEquality(typescript_1.default.factory.createNumericLiteral(regular.filter(function (r) { return r.meta.required; }).length), length)
                    : typescript_1.default.factory.createCallExpression(importer.use("is_between"), [], [
                        length,
                        typescript_1.default.factory.createNumericLiteral(regular.filter(function (r) { return r.meta.required; }).length),
