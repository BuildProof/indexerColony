        ...
        return function (obj) {
            return function (nullable) {
                ...
                var _loop_1 = function (property) {
                    ...
                    var schema_1 = (0, application_schema_1.application_schema)(options)(true)(components)(property.value)({
                    ...
                    if (schema_1 === null)
                        ...
                        if (pattern === PatternUtil_1.PatternUtil.STRING)
                            extraMeta.additionalProperties = [property.value, schema_1];
                        else
                ...
                try {
                    for (var _c = __values(obj.properties), _d = _c.next(); !_d.done; _d = _c.next()) {
                ...
                var extraProps = {
                    additionalProperties: (_b = extraMeta.additionalProperties) === null || _b === void 0 ? void 0 : _b[1],
                    patternProperties: (function () {
                        ...
                        try {
                            for (var _b = __values(Object.entries(extraMeta.patternProperties)), _c = _b.next(); !_c.done; _c = _b.next()) {
                                var _d = __read(_c.value, 2), key_2 = _d[0], value = _d[1];
                                output[key_2] = value[1];
                            }
                        }
                ...
                var schema = __assign({ $id: options.purpose === "ajv"
                        ? "".concat(JSON_SCHEMA_PREFIX_1.JSON_SCHEMA_PREFIX, "/").concat(key)
                        : undefined, $recursiveAnchor: (options.purpose === "ajv" && obj.recursive) || undefined, type: "object", properties: properties, nullable: options.purpose === "swagger" ? nullable : undefined, required: required.length ? required : undefined, description: obj.description, "x-typia-jsDocTags": obj.jsDocTags }, (options.purpose === "ajv"
                    ? extraProps
                    : {
