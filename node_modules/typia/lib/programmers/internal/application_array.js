        ...
        return function (tuple) {
            return function (metadata) {
                return function (attribute) {
                    var e_1, _a;
                    var _b;
                    var output = __assign(__assign({}, attribute), { type: "array", items: (0, application_schema_1.application_schema)(options)(false)(components)(metadata)(attribute), "x-typia-tuple": tuple });
                    try {
