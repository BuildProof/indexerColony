...
(function (CloneProgrammer) {
    CloneProgrammer.generate = function (project, modulo) {
        return function (type, name) {
            return CloneProgrammer.write(project)(modulo)(type, name);
        };
    };
    CloneProgrammer.write = function (project) { return function (modulo) {
        var importer = new FunctionImporeter_1.FunctionImporter();
        return FeatureProgrammer_1.FeatureProgrammer.analyze(project)(__assign(__assign({}, CONFIG(project, importer)), { addition: function (collection) {
    ...
    var decode = function (project, importer) {
        return function (input, meta, explore) {
            ...
            if (meta.resolved !== null)
                unions.push({
                    type: "resolved",
                    is: function () { return IsProgrammer_1.IsProgrammer.decode_to_json(true)(input); },
                    value: function () {
    ...
    var decode_to_json = function (project, importer) {
        return function (input, resolved, explore) {
            return decode(project, importer)(typescript_1.default.factory.createCallExpression(IdentifierFactory_1.IdentifierFactory.access(input)("toJSON"), undefined, []), resolved, explore);
        };
    };
    var decode_tuple = function (project, importer) {
        return function (input, tuple, explore) {
            ...
            var rest = (function () {
                ...
                if (rest === null)
                    return null;
                return decode(project, importer)(typescript_1.default.factory.createCallExpression(IdentifierFactory_1.IdentifierFactory.access(input)("slice"), undefined, [typescript_1.default.factory.createNumericLiteral(tuple.length - 1)]), (function () {
