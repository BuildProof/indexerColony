...
(function (ValidateProgrammer) {
    ValidateProgrammer.generate = function (project, modulo, equals) {
        ...
        return function (type, name) {
            return ValidateProgrammer.write(project)(modulo)(equals)(type, name);
        };
    };
                    ...
                    var program = CheckerProgrammer_1.CheckerProgrammer.write(project)({
                        ...
                        atomist: function (explore) { return function (tuple) { return function (input) {
                            return __spreadArray([
                                ...
                                return typescript_1.default.factory.createLogicalOr(tag.expression, create_report_call(explore.from === "top"
