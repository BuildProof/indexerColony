...
exports.IsParseProgrammer = void 0;
var typescript_1 = __importDefault(require("typescript"));
var IdentifierFactory_1 = require("../factories/IdentifierFactory");
var StatementFactory_1 = require("../factories/StatementFactory");
var TypeFactory_1 = require("../factories/TypeFactory");
var IsProgrammer_1 = require("./IsProgrammer");
var IsParseProgrammer;
(function (IsParseProgrammer) {
    IsParseProgrammer.generate = function (project, modulo) {
        return function (type, name) {
            return IsParseProgrammer.write(project)(modulo)(type, name);
        };
    };
    IsParseProgrammer.write = function (project) {
...
})(IsParseProgrammer = exports.IsParseProgrammer || (exports.IsParseProgrammer = {}));
