...
(function (TypiaProgrammer) {
    ...
    TypiaProgrammer.build = function (props) { return __awaiter(_this, void 0, void 0, function () {
        var parent_1, compilerOptions, program, _a, _b, result, printer, _c, _d, file, to, content, e_1_1;
        var e_1, _e;
        var _this = this;
        var _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 9:
                    program = _b.apply(_a, [_h.sent(), compilerOptions]);
                    result = typescript_1.default.transform(program
                        ...
                        (0, transform_1.default)(program, (_g = ((_f = compilerOptions.plugins) !== null && _f !== void 0 ? _f : []).find(function (p) {
        ...
        return function (container) {
            return function (from) {
                return function (to) { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b, file, next, stat, e_2_1;
                    var e_2, _c;
...
})(TypiaProgrammer = exports.TypiaProgrammer || (exports.TypiaProgrammer = {}));
