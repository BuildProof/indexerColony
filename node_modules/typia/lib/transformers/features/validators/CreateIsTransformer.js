...
(function (CreateIsTransformer) {
    CreateIsTransformer.transform = function (equals) {
        return GenericTransformer_1.GenericTransformer.factory(equals ? "createEquals" : "createIs")(function (project) { return function (modulo) {
            return IsProgrammer_1.IsProgrammer.write(project)(modulo)(equals);
        }; });
    };
