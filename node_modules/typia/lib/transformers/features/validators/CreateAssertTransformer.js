...
(function (CreateAssertTransformer) {
    CreateAssertTransformer.transform = function (equals) {
        return GenericTransformer_1.GenericTransformer.factory(equals ? "createAssertEquals" : "createAssert")(function (project) { return function (modulo) {
            return AssertProgrammer_1.AssertProgrammer.write(project)(modulo)(equals);
        }; });
    };
