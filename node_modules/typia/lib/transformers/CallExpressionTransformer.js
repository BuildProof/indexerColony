...
var CreateRandomTransformer_1 = require("./features/miscellaneous/CreateRandomTransformer");
...
var FUNCTORS = {
    ...
    application: function () { return function (project) { return function () {
        return ApplicationTransformer_1.ApplicationTransformer.transform(project);
    }; }; },
    ...
    metadata: function () { return function (project) { return function () { return MetadataTransformer_1.MetadataTransformer.transform(project); }; }; },
    random: function () { return RandomTransformer_1.RandomTransformer.transform; },
    literals: function () { return function (project) { return function () { return LiteralsTransformer_1.LiteralsTransformer.transform(project); }; }; },
